...
class CueSheetType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ProprietaryIdType[] $cueSheetId
     */
    private $cueSheetId = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\CueSheetTypeType $cueSheetType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\CueType[] $cue
     */
    private $cue = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\ProprietaryIdType $cueSheetId
     */
    public function addToCueSheetId(\DedexBundle\Entity\Ern431\ProprietaryIdType $cueSheetId)
    {
     ...
     * A Composite containing details of a Type of the CueSheet.
     *
     * @return \DedexBundle\Entity\Ern431\CueSheetTypeType
     */
     ...
     * A Composite containing details of a Type of the CueSheet.
     *
     * @param \DedexBundle\Entity\Ern431\CueSheetTypeType $cueSheetType
     * @return self
     */
    public function setCueSheetType(\DedexBundle\Entity\Ern431\CueSheetTypeType $cueSheetType)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\CueType $cue
     */
    public function addToCue(\DedexBundle\Entity\Ern431\CueType $cue)
    {
        $this->cue[] = $cue;
        return $this;
    }
     ...
     * A Composite containing details of a Cue.
     *
     * @return \DedexBundle\Entity\Ern431\CueType[]
     */

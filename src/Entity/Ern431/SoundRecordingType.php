...
class SoundRecordingType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\SoundRecordingTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \DedexBundle\Entity\Ern431\SoundRecordingEditionType[] $soundRecordingEdition
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\FirstPublicationDateType[] $firstPublicationDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\LocationAndDateOfSessionType[] $locationAndDateOfSession
     */
     ...
     * A Composite containing details of the Type of the SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern431\SoundRecordingTypeType
     */
     ...
     * A Composite containing details of the Type of the SoundRecording.
     *
     * @param \DedexBundle\Entity\Ern431\SoundRecordingTypeType $type
     * @return self
     */
    public function setType(\DedexBundle\Entity\Ern431\SoundRecordingTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\SoundRecordingEditionType $soundRecordingEdition
     */
    public function addToSoundRecordingEdition(\DedexBundle\Entity\Ern431\SoundRecordingEditionType $soundRecordingEdition)
    {
     ...
     * A Composite containing details of a SoundRecording that has been created based on the same content as the 'main' SoundRecording but specifically for a different encoding such as immersive audio. It can be the same SoundRecording (in accordance with the ISRC standard) but more likely than not will be a different SoundRecording because the sound engineer/producer will be different. If an element in this Composite is not provided, the data is assumed to be the same as for the 'main' SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern431\SoundRecordingEditionType[]
     */
     ...
     * @return self
     */
    public function setRemasteredDate(?\DedexBundle\Entity\Ern431\EventDateWithoutFlagsType $remasteredDate = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\FirstPublicationDateType $firstPublicationDate
     */
    public function addToFirstPublicationDate(\DedexBundle\Entity\Ern431\FirstPublicationDateType $firstPublicationDate)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the SoundRecording was first published, whether for physical or electronic/online distribution. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @return \DedexBundle\Entity\Ern431\FirstPublicationDateType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\LocationAndDateOfSessionType $locationAndDateOfSession
     */
    public function addToLocationAndDateOfSession(\DedexBundle\Entity\Ern431\LocationAndDateOfSessionType $locationAndDateOfSession)
    {
     ...
     * A Composite containing details of a RecordingSession.
     *
     * @return \DedexBundle\Entity\Ern431\LocationAndDateOfSessionType[]
     */

...
class DisplayTitleType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\DisplaySubTitleType[] $subTitle
     */
    private $subTitle = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\DisplaySubTitleType $subTitle
     */
    public function addToSubTitle(\DedexBundle\Entity\Ern431\DisplaySubTitleType $subTitle)
    {
     ...
     * A Composite containing details of a SubTitle of the Title, including Titles of Versions used to differentiate different versions of the same Title, as required by the GRid and ISRC ReferenceDescriptiveMetadataSets.
     *
     * @return \DedexBundle\Entity\Ern431\DisplaySubTitleType[]
     */

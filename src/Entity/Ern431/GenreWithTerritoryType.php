...
class GenreWithTerritoryType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\GenreCategoryType[] $genreCategory
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\SubGenreCategoryType[] $subGenreCategory
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\GenreCategoryType $genreCategory
     */
    public function addToGenreCategory(\DedexBundle\Entity\Ern431\GenreCategoryType $genreCategory)
    {
     ...
     * A Composite containing details of a Genre Category to which the Release belongs.
     *
     * @return \DedexBundle\Entity\Ern431\GenreCategoryType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\SubGenreCategoryType $subGenreCategory
     */
    public function addToSubGenreCategory(\DedexBundle\Entity\Ern431\SubGenreCategoryType $subGenreCategory)
    {
     ...
     * A Composite containing details of a sub-genre of the Release. The sub-genre is a specialization of the genre and therefore the GenreCategory needs to be provided if this element is provided.
     *
     * @return \DedexBundle\Entity\Ern431\SubGenreCategoryType[]
     */

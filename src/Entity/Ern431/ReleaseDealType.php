...
class ReleaseDealType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\DealType[] $deal
     */
    private $deal = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\DealType $deal
     */
    public function addToDeal(\DedexBundle\Entity\Ern431\DealType $deal)
    {
        $this->deal[] = $deal;
        return $this;
    }
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/no-takedown-in-initial-deal
     *
     * @return \DedexBundle\Entity\Ern431\DealType[]
     */

...
class ChapterListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ChapterType[] $chapter
     */
    private $chapter = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\ChapterType $chapter
     */
    public function addToChapter(\DedexBundle\Entity\Ern431\ChapterType $chapter)
    {
     ...
     * A Composite containing details of a Chapter contained in a Resource.
     *
     * @return \DedexBundle\Entity\Ern431\ChapterType[]
     */

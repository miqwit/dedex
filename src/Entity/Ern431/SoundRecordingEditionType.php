...
class SoundRecordingEditionType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\SoundRecordingIdType[] $resourceId
     */
    private $resourceId = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\EditionContributorType[] $editionContributor
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\TechnicalSoundRecordingDetailsType[] $technicalDetails
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\SoundRecordingIdType $resourceId
     */
    public function addToResourceId(\DedexBundle\Entity\Ern431\SoundRecordingIdType $resourceId)
    {
     ...
     * A Composite containing details of a SoundRecordingId.
     *
     * @return \DedexBundle\Entity\Ern431\SoundRecordingIdType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\EditionContributorType $editionContributor
     */
    public function addToEditionContributor(\DedexBundle\Entity\Ern431\EditionContributorType $editionContributor)
    {
     ...
     * A Composite containing details of a Contributor to the SoundRecordingEdition (but not all other editions).
     *
     * @return \DedexBundle\Entity\Ern431\EditionContributorType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\TechnicalSoundRecordingDetailsType $technicalDetails
     */
    public function addToTechnicalDetails(\DedexBundle\Entity\Ern431\TechnicalSoundRecordingDetailsType $technicalDetails)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-binaries/communicating-binaries
     *
     * @return \DedexBundle\Entity\Ern431\TechnicalSoundRecordingDetailsType[]
     */

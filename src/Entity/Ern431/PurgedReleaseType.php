...
class PurgedReleaseType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\TitleType[] $title
     */
    private $title = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\DetailedResourceContributorType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\TitleType $title
     */
    public function addToTitle(\DedexBundle\Entity\Ern431\TitleType $title)
    {
        $this->title[] = $title;
        return $this;
    }
     ...
     * A Composite containing details of a Title of the Release.
     *
     * @return \DedexBundle\Entity\Ern431\TitleType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\DetailedResourceContributorType $contributor
     */
    public function addToContributor(\DedexBundle\Entity\Ern431\DetailedResourceContributorType $contributor)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/information-on-displayartists%2C-displayartistnames%2C-contributors-and-indirectcontributors
     *
     * @return \DedexBundle\Entity\Ern431\DetailedResourceContributorType[]
     */

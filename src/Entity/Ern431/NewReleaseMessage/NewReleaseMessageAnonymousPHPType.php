...
namespace DedexBundle\Entity\Ern431\NewReleaseMessage;
...
class NewReleaseMessageAnonymousPHPType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ReleaseAdminType[] $releaseAdmin
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PartyListType $partyList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\CueSheetType[] $cueSheetList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ResourceListType $resourceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ChapterListType $chapterList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ReleaseListType $releaseList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\DealListType $dealList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\FileType[] $supplementalDocumentList
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\ReleaseAdminType $releaseAdmin
     */
    public function addToReleaseAdmin(\DedexBundle\Entity\Ern431\ReleaseAdminType $releaseAdmin)
    {
     ...
     * A Composite containing details of Release administration.
     *
     * @return \DedexBundle\Entity\Ern431\ReleaseAdminType[]
     */
     ...
     * A Composite containing details of one or more Parties relating to the reported Creations.
     *
     * @return \DedexBundle\Entity\Ern431\PartyListType
     */
     ...
     * A Composite containing details of one or more Parties relating to the reported Creations.
     *
     * @param \DedexBundle\Entity\Ern431\PartyListType $partyList
     * @return self
     */
    public function setPartyList(\DedexBundle\Entity\Ern431\PartyListType $partyList)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\CueSheetType $cueSheet
     */
    public function addToCueSheetList(\DedexBundle\Entity\Ern431\CueSheetType $cueSheet)
    {
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @return \DedexBundle\Entity\Ern431\CueSheetType[]
     */
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @param \DedexBundle\Entity\Ern431\CueSheetType[] $cueSheetList
     * @return self
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @return \DedexBundle\Entity\Ern431\ResourceListType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @param \DedexBundle\Entity\Ern431\ResourceListType $resourceList
     * @return self
     */
    public function setResourceList(\DedexBundle\Entity\Ern431\ResourceListType $resourceList)
    {
     ...
     * A Composite containing details of one or more Chapters contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @return \DedexBundle\Entity\Ern431\ChapterListType
     */
     ...
     * A Composite containing details of one or more Chapters contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @param \DedexBundle\Entity\Ern431\ChapterListType $chapterList
     * @return self
     */
    public function setChapterList(?\DedexBundle\Entity\Ern431\ChapterListType $chapterList = null)
    {
     ...
     * A Composite containing details of one or more DDEX Releases contained in the NewReleaseMessage.
     *
     * @return \DedexBundle\Entity\Ern431\ReleaseListType
     */
     ...
     * A Composite containing details of one or more DDEX Releases contained in the NewReleaseMessage.
     *
     * @param \DedexBundle\Entity\Ern431\ReleaseListType $releaseList
     * @return self
     */
    public function setReleaseList(\DedexBundle\Entity\Ern431\ReleaseListType $releaseList)
    {
     ...
     * A Composite containing details of one or more Deals governing the Usage of the Releases in the Message.
     *
     * @return \DedexBundle\Entity\Ern431\DealListType
     */
     ...
     * A Composite containing details of one or more Deals governing the Usage of the Releases in the Message.
     *
     * @param \DedexBundle\Entity\Ern431\DealListType $dealList
     * @return self
     */
    public function setDealList(?\DedexBundle\Entity\Ern431\DealListType $dealList = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\FileType $supplementalDocument
     */
    public function addToSupplementalDocumentList(\DedexBundle\Entity\Ern431\FileType $supplementalDocument)
    {
     ...
     * A Composite containing details of one or more XML documents communicated with the Message.
     *
     * @param \DedexBundle\Entity\Ern431\FileType[] $supplementalDocumentList
     * @return self
     */

...
class SoundRecordingClipDetailsType
{
     ...
     * A Type of clip.
     *
     * @var \DedexBundle\Entity\Ern431\ClipTypeType $clipType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\TimingType[] $timing
     */
    private $timing = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\AudioDeliveryFileType[] $deliveryFile
     */
     ...
     * A Type of clip.
     *
     * @return \DedexBundle\Entity\Ern431\ClipTypeType
     */
     ...
     * A Type of clip.
     *
     * @param \DedexBundle\Entity\Ern431\ClipTypeType $clipType
     * @return self
     */
    public function setClipType(\DedexBundle\Entity\Ern431\ClipTypeType $clipType)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\TimingType $timing
     */
    public function addToTiming(\DedexBundle\Entity\Ern431\TimingType $timing)
    {
        $this->timing[] = $timing;
        return $this;
    }
     ...
     * A Composite containing details of a StartTime, EndTime and a Duration of the clip.
     *
     * @return \DedexBundle\Entity\Ern431\TimingType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\AudioDeliveryFileType $deliveryFile
     */
    public function addToDeliveryFile(\DedexBundle\Entity\Ern431\AudioDeliveryFileType $deliveryFile)
    {
     ...
     * A Composite containing details of a delivery File.
     *
     * @return \DedexBundle\Entity\Ern431\AudioDeliveryFileType[]
     */

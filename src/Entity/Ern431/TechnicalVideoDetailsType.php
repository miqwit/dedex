...
class TechnicalVideoDetailsType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\BitRateType $overallBitRate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\VideoDeliveryFileType[] $deliveryFile
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\VideoClipDetailsType[] $clipDetails
     */
    private $clipDetails = [
     ...
     * A Composite containing the overall BitRate and a UnitOfMeasure (the default is kbps).
     *
     * @param \DedexBundle\Entity\Ern431\BitRateType $overallBitRate
     * @return self
     */
    public function setOverallBitRate(?\DedexBundle\Entity\Ern431\BitRateType $overallBitRate = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\VideoDeliveryFileType $deliveryFile
     */
    public function addToDeliveryFile(\DedexBundle\Entity\Ern431\VideoDeliveryFileType $deliveryFile)
    {
     ...
     * A Composite containing details of a delivery File.
     *
     * @return \DedexBundle\Entity\Ern431\VideoDeliveryFileType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\VideoClipDetailsType $clipDetails
     */
    public function addToClipDetails(\DedexBundle\Entity\Ern431\VideoClipDetailsType $clipDetails)
    {
     ...
     * A Composite containing details of a preview.
     *
     * @return \DedexBundle\Entity\Ern431\VideoClipDetailsType[]
     */

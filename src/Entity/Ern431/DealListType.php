...
class DealListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ReleaseDealType[] $releaseDeal
     */
    private $releaseDeal = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ReleaseVisibilityType[] $releaseVisibility
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\TrackReleaseVisibilityType[] $trackReleaseVisibility
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\ReleaseDealType $releaseDeal
     */
    public function addToReleaseDeal(\DedexBundle\Entity\Ern431\ReleaseDealType $releaseDeal)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/complex-deals-can-be-dangerous
     *
     * @return \DedexBundle\Entity\Ern431\ReleaseDealType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\ReleaseVisibilityType $releaseVisibility
     */
    public function addToReleaseVisibility(\DedexBundle\Entity\Ern431\ReleaseVisibilityType $releaseVisibility)
    {
     ...
     * A Composite containing details of a set of Dates specifying when a Release can be shown to Consumers.
     *
     * @return \DedexBundle\Entity\Ern431\ReleaseVisibilityType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\TrackReleaseVisibilityType $trackReleaseVisibility
     */
    public function addToTrackReleaseVisibility(\DedexBundle\Entity\Ern431\TrackReleaseVisibilityType $trackReleaseVisibility)
    {
     ...
     * A Composite containing details of a set of Dates specifying when a TrackRelease can be shown to Consumers.
     *
     * @return \DedexBundle\Entity\Ern431\TrackReleaseVisibilityType[]
     */

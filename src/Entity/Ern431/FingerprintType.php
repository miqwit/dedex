...
class FingerprintType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\FingerprintAlgorithmTypeType $algorithm
     */
     ...
     * A Composite containing details of the Type of Algorithm governing the Fingerprint.
     *
     * @return \DedexBundle\Entity\Ern431\FingerprintAlgorithmTypeType
     */
     ...
     * A Composite containing details of the Type of Algorithm governing the Fingerprint.
     *
     * @param \DedexBundle\Entity\Ern431\FingerprintAlgorithmTypeType $algorithm
     * @return self
     */
    public function setAlgorithm(\DedexBundle\Entity\Ern431\FingerprintAlgorithmTypeType $algorithm)
    {

...
class DelegatedUsageRightsType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\UseTypeType[] $useType
     */
    private $useType = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PeriodType $periodOfRightsDelegation
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\AllTerritoryCodeType[] $territoryOfRightsDelegation
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\UseTypeType $useType
     */
    public function addToUseType(\DedexBundle\Entity\Ern431\UseTypeType $useType)
    {
     ...
     * A Composite containing details of the use for which Rights are delegated.
     *
     * @return \DedexBundle\Entity\Ern431\UseTypeType[]
     */
     ...
     * A Composite containing details about a Period of Time for which the delegation of usage Rights applies. Periods are typically described by at least a StartDate or EndDate.
     *
     * @param \DedexBundle\Entity\Ern431\PeriodType $periodOfRightsDelegation
     * @return self
     */
    public function setPeriodOfRightsDelegation(?\DedexBundle\Entity\Ern431\PeriodType $periodOfRightsDelegation = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\AllTerritoryCodeType $territoryOfRightsDelegation
     */
    public function addToTerritoryOfRightsDelegation(\DedexBundle\Entity\Ern431\AllTerritoryCodeType $territoryOfRightsDelegation)
    {
     ...
     * A Territory for which the delegation of usage rights applies.
     *
     * @return \DedexBundle\Entity\Ern431\AllTerritoryCodeType[]
     */

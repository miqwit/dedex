...
class WorkRightsControllerType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\AllTerritoryCodeType[] $territory
     */
    private $territory = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\AllTerritoryCodeType $territory
     */
    public function addToTerritory(\DedexBundle\Entity\Ern431\AllTerritoryCodeType $territory)
    {

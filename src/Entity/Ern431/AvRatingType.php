...
class AvRatingType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\RatingAgencyType $agency
     */
    private $agency = null;
     ...
     *
     * @var \DedexBundle\Entity\Ern431\RatingReasonType $reason
     */
    private $reason = null;
     ...
     * A Composite containing details of an Organization that issues the AvRating.
     *
     * @return \DedexBundle\Entity\Ern431\RatingAgencyType
     */
     ...
     * A Composite containing details of an Organization that issues the AvRating.
     *
     * @param \DedexBundle\Entity\Ern431\RatingAgencyType $agency
     * @return self
     */
    public function setAgency(\DedexBundle\Entity\Ern431\RatingAgencyType $agency)
    {
        $this->agency = $agency;
        return $this;
    }
     ...
     * A Composite containing details of a Reason for a rating being applied.
     *
     * @return \DedexBundle\Entity\Ern431\RatingReasonType
     */
     ...
     * A Composite containing details of a Reason for a rating being applied.
     *
     * @param \DedexBundle\Entity\Ern431\RatingReasonType $reason
     * @return self
     */
    public function setReason(?\DedexBundle\Entity\Ern431\RatingReasonType $reason = null)
    {
        $this->reason = $reason;
        return $this;
    }

...
class ServiceExceptionType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PartyNameType[] $partyName
     */
    private $partyName = [
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @var \DedexBundle\Entity\Ern431\NameType $tradingName
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ChannelType[] $channel
     */
    private $channel = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\PartyNameType $partyName
     */
    public function addToPartyName(\DedexBundle\Entity\Ern431\PartyNameType $partyName)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @return \DedexBundle\Entity\Ern431\PartyNameType[]
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @param \DedexBundle\Entity\Ern431\NameType $tradingName
     * @return self
     */
    public function setTradingName(?\DedexBundle\Entity\Ern431\NameType $tradingName = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\ChannelType $channel
     */
    public function addToChannel(\DedexBundle\Entity\Ern431\ChannelType $channel)
    {
     ...
     * A Composite containing details of an excluded channel provided by the Service. This channel may be specific to an Artist.
     *
     * @return \DedexBundle\Entity\Ern431\ChannelType[]
     */

...
class DistributionChannelPageType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\NameType $pageName
     */
     ...
     * A Composite containing the Name of the WebPage.
     *
     * @param \DedexBundle\Entity\Ern431\NameType $pageName
     * @return self
     */
    public function setPageName(?\DedexBundle\Entity\Ern431\NameType $pageName = null)
    {

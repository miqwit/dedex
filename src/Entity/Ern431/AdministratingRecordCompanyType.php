...
class AdministratingRecordCompanyType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\AdministratingRecordCompanyRoleType $role
     */
    private $role = null;
     ...
     * The role played by the Party responsible for administering Rights in a Resource or a Release.
     *
     * @return \DedexBundle\Entity\Ern431\AdministratingRecordCompanyRoleType
     */
     ...
     * The role played by the Party responsible for administering Rights in a Resource or a Release.
     *
     * @param \DedexBundle\Entity\Ern431\AdministratingRecordCompanyRoleType $role
     * @return self
     */
    public function setRole(\DedexBundle\Entity\Ern431\AdministratingRecordCompanyRoleType $role)
    {
        $this->role = $role;
        return $this;
    }

...
class ReleaseType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ReleaseTypeForReleaseNotificationType[] $releaseType
     */
    private $releaseType = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\AdministratingRecordCompanyType[] $administratingRecordCompany
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PLineType[] $pLine
     */
    private $pLine = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\EventDateWithDefaultType[] $releaseDate
     */
    private $releaseDate = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\EventDateWithDefaultType[] $originalReleaseDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ResourceGroupType $resourceGroup
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ExternalResourceLinkType[] $externalResourceLink
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\RagaType[] $raga
     */
    private $raga = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\TalaType[] $tala
     */
    private $tala = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\DeityType[] $deity
     */
    private $deity = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\ReleaseTypeForReleaseNotificationType $releaseType
     */
    public function addToReleaseType(\DedexBundle\Entity\Ern431\ReleaseTypeForReleaseNotificationType $releaseType)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/release-types-for-trackreleases
     *
     * @return \DedexBundle\Entity\Ern431\ReleaseTypeForReleaseNotificationType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\AdministratingRecordCompanyType $administratingRecordCompany
     */
    public function addToAdministratingRecordCompany(\DedexBundle\Entity\Ern431\AdministratingRecordCompanyType $administratingRecordCompany)
    {
     ...
     * A Composite containing details of the AdministratingRecordCompany for the Release.
     *
     * @return \DedexBundle\Entity\Ern431\AdministratingRecordCompanyType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\PLineType $pLine
     */
    public function addToPLine(\DedexBundle\Entity\Ern431\PLineType $pLine)
    {
        $this->pLine[] = $pLine;
        return $this;
    }
     ...
     * A Composite containing details of the PLine for the Release.
     *
     * @return \DedexBundle\Entity\Ern431\PLineType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\EventDateWithDefaultType $releaseDate
     */
    public function addToReleaseDate(\DedexBundle\Entity\Ern431\EventDateWithDefaultType $releaseDate)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601 format: YYYY[-MM[-DD]]). This Element is for display and cataloguing purposes only.
     *
     * @return \DedexBundle\Entity\Ern431\EventDateWithDefaultType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\EventDateWithDefaultType $originalReleaseDate
     */
    public function addToOriginalReleaseDate(\DedexBundle\Entity\Ern431\EventDateWithDefaultType $originalReleaseDate)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @return \DedexBundle\Entity\Ern431\ResourceGroupType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @param \DedexBundle\Entity\Ern431\ResourceGroupType $resourceGroup
     * @return self
     */
    public function setResourceGroup(\DedexBundle\Entity\Ern431\ResourceGroupType $resourceGroup)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\ExternalResourceLinkType $externalResourceLink
     */
    public function addToExternalResourceLink(\DedexBundle\Entity\Ern431\ExternalResourceLinkType $externalResourceLink)
    {
     ...
     * A Composite containing details of promotional or other material related to the Release.
     *
     * @return \DedexBundle\Entity\Ern431\ExternalResourceLinkType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\RagaType $raga
     */
    public function addToRaga(\DedexBundle\Entity\Ern431\RagaType $raga)
    {
        $this->raga[] = $raga;
        return $this;
    }
     ...
     * A Description of the melodic mode of a MusicalWork in the Release.
     *
     * @return \DedexBundle\Entity\Ern431\RagaType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\TalaType $tala
     */
    public function addToTala(\DedexBundle\Entity\Ern431\TalaType $tala)
    {
        $this->tala[] = $tala;
        return $this;
    }
     ...
     * A Description of the rhythmic pattern of a MusicalWork in the Release.
     *
     * @return \DedexBundle\Entity\Ern431\TalaType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\DeityType $deity
     */
    public function addToDeity(\DedexBundle\Entity\Ern431\DeityType $deity)
    {
        $this->deity[] = $deity;
        return $this;
    }
     ...
     * A deity name relating to the Release.
     *
     * @return \DedexBundle\Entity\Ern431\DeityType[]
     */

...
class ChapterType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ChapterIdType[] $chapterId
     */
    private $chapterId = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\ChapterIdType $chapterId
     */
    public function addToChapterId(\DedexBundle\Entity\Ern431\ChapterIdType $chapterId)
    {
     ...
     * A Composite containing details of an Identifier of the Chapter or of the content of the Chapter.
     *
     * @return \DedexBundle\Entity\Ern431\ChapterIdType[]
     */

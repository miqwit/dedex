...
class CharacterType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ContributorType $performer
     */
     ...
     * A Composite containing details of the Name, Identifier and Role(s) of a Performer.
     *
     * @param \DedexBundle\Entity\Ern431\ContributorType $performer
     * @return self
     */
    public function setPerformer(?\DedexBundle\Entity\Ern431\ContributorType $performer = null)
    {

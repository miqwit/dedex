...
class PriceInformationType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PriceTypeType $priceCode
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PriceType $wholesalePricePerUnit
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PriceType $bulkOrderWholesalePricePerUnit
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PriceType $suggestedRetailPrice
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/price-information
     *
     * @return \DedexBundle\Entity\Ern431\PriceTypeType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/price-information
     *
     * @param \DedexBundle\Entity\Ern431\PriceTypeType $priceCode
     * @return self
     */
    public function setPriceCode(?\DedexBundle\Entity\Ern431\PriceTypeType $priceCode = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit of Usage, which informs the informs the DSP of the Price the Release should be offered at. Note that this Price applies to all UseTypes referenced in a DealTerm Composite. This element should not be combined with PriceType.
     *
     * @return \DedexBundle\Entity\Ern431\PriceType
     */
     ...
     * A Composite containing details of a wholesale Price for a single unit of Usage, which informs the informs the DSP of the Price the Release should be offered at. Note that this Price applies to all UseTypes referenced in a DealTerm Composite. This element should not be combined with PriceType.
     *
     * @param \DedexBundle\Entity\Ern431\PriceType $wholesalePricePerUnit
     * @return self
     */
    public function setWholesalePricePerUnit(?\DedexBundle\Entity\Ern431\PriceType $wholesalePricePerUnit = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit, which informs the informs the DSP of the Price the Release should be offered at. Note that the size of a bulk order is defined in the contract between MessageSender and the MessageRecipient. This element should not be combined with PriceType.
     *
     * @param \DedexBundle\Entity\Ern431\PriceType $bulkOrderWholesalePricePerUnit
     * @return self
     */
    public function setBulkOrderWholesalePricePerUnit(?\DedexBundle\Entity\Ern431\PriceType $bulkOrderWholesalePricePerUnit = null)
    {
     ...
     * A Composite containing details of a suggested retail Price.
     *
     * @param \DedexBundle\Entity\Ern431\PriceType $suggestedRetailPrice
     * @return self
     */
    public function setSuggestedRetailPrice(?\DedexBundle\Entity\Ern431\PriceType $suggestedRetailPrice = null)
    {

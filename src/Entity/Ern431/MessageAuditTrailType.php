...
class MessageAuditTrailType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\MessageAuditTrailEventType[] $messageAuditTrailEvent
     */
     ...
     */
    public function addToMessageAuditTrailEvent(\DedexBundle\Entity\Ern431\MessageAuditTrailEventType $messageAuditTrailEvent)
    {

...
class AudioDeliveryFileType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\BitRateType $bitRate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\BitRateType $originalBitRate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\SamplingRateType $samplingRate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\SamplingRateType $originalSamplingRate
     */
     ...
     * A Composite containing the BitRate for the audio data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DedexBundle\Entity\Ern431\BitRateType $bitRate
     * @return self
     */
    public function setBitRate(?\DedexBundle\Entity\Ern431\BitRateType $bitRate = null)
    {
     ...
     * A Composite containing the BitRate for the audio data recording and a UnitOfMeasure (the default is kbps).
     *
     * @param \DedexBundle\Entity\Ern431\BitRateType $originalBitRate
     * @return self
     */
    public function setOriginalBitRate(?\DedexBundle\Entity\Ern431\BitRateType $originalBitRate = null)
    {
     ...
     * A Composite containing the sampling rate of the SoundRecording and a UnitOfMeasure (the default is Hz).
     *
     * @param \DedexBundle\Entity\Ern431\SamplingRateType $samplingRate
     * @return self
     */
    public function setSamplingRate(?\DedexBundle\Entity\Ern431\SamplingRateType $samplingRate = null)
    {
     ...
     * A Composite containing the sampling rate of the SoundRecording during the recording, and a UnitOfMeasure (the default is Hz).
     *
     * @param \DedexBundle\Entity\Ern431\SamplingRateType $originalSamplingRate
     * @return self
     */
    public function setOriginalSamplingRate(?\DedexBundle\Entity\Ern431\SamplingRateType $originalSamplingRate = null)
    {

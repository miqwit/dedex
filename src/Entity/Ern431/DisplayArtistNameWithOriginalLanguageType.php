...
/**
 * Class representing DisplayArtistNameWithOriginalLanguageType
 *
 * A Composite containing details of a DisplayArtistName.
 * Explanatory Note: This Composite is named DisplayArtistNameWithOriginalLanguage to disambiguate it from the basic DisplayArtistName Composite.
 * XSD Type: DisplayArtistNameWithOriginalLanguage
 */
class DisplayArtistNameWithOriginalLanguageType
{
    /**
     * @var string $__value
     */

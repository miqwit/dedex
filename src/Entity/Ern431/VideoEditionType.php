...
class VideoEditionType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\VideoIdType[] $resourceId
     */
    private $resourceId = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\TechnicalVideoDetailsType[] $technicalDetails
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\VideoIdType $resourceId
     */
    public function addToResourceId(\DedexBundle\Entity\Ern431\VideoIdType $resourceId)
    {
     ...
     * A Composite containing details of a VideoId.
     *
     * @return \DedexBundle\Entity\Ern431\VideoIdType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\TechnicalVideoDetailsType $technicalDetails
     */
    public function addToTechnicalDetails(\DedexBundle\Entity\Ern431\TechnicalVideoDetailsType $technicalDetails)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-binaries/communicating-binaries
     *
     * @return \DedexBundle\Entity\Ern431\TechnicalVideoDetailsType[]
     */

...
class ExternalResourceLinkType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PeriodWithoutFlagsType $validityPeriod
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ExternallyLinkedResourceTypeType[] $externallyLinkedResourceType
     */
     ...
     * A Composite containing details about the Period of Time during which the ExternalResourceLink is active. StartDate and EndDate are deprecated and StartDateTime/EndDateTime should be used instead. DDEX advises that StartDate and EndDate may be removed at a future date and therefore recommends against using them.
     *
     * @return \DedexBundle\Entity\Ern431\PeriodWithoutFlagsType
     */
     ...
     * A Composite containing details about the Period of Time during which the ExternalResourceLink is active. StartDate and EndDate are deprecated and StartDateTime/EndDateTime should be used instead. DDEX advises that StartDate and EndDate may be removed at a future date and therefore recommends against using them.
     *
     * @param \DedexBundle\Entity\Ern431\PeriodWithoutFlagsType $validityPeriod
     * @return self
     */
    public function setValidityPeriod(?\DedexBundle\Entity\Ern431\PeriodWithoutFlagsType $validityPeriod = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\ExternallyLinkedResourceTypeType $externallyLinkedResourceType
     */
    public function addToExternallyLinkedResourceType(\DedexBundle\Entity\Ern431\ExternallyLinkedResourceTypeType $externallyLinkedResourceType)
    {
     ...
     * A Composite containing details of the Type of a Resource pointed to by the ExternalResourceLink.
     *
     * @return \DedexBundle\Entity\Ern431\ExternallyLinkedResourceTypeType[]
     */

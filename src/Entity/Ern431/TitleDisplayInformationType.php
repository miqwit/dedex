...
class TitleDisplayInformationType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PrefixType[] $prefix
     */
    private $prefix = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\PrefixType $prefix
     */
    public function addToPrefix(\DedexBundle\Entity\Ern431\PrefixType $prefix)
    {
        $this->prefix[] = $prefix;
        return $this;
    }
     ...
     * A Descriptor that precedes the display artist name when multiple display artist names are given.
     *
     * @return \DedexBundle\Entity\Ern431\PrefixType[]
     */

...
class PartyType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\DetailedPartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PartyNameWithTerritoryType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\AffiliationType[] $affiliation
     */
    private $affiliation = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\RelatedPartyType[] $relatedParty
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\DetailedPartyIdType $partyId
     */
    public function addToPartyId(\DedexBundle\Entity\Ern431\DetailedPartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DedexBundle\Entity\Ern431\DetailedPartyIdType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\PartyNameWithTerritoryType $partyName
     */
    public function addToPartyName(\DedexBundle\Entity\Ern431\PartyNameWithTerritoryType $partyName)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\AffiliationType $affiliation
     */
    public function addToAffiliation(\DedexBundle\Entity\Ern431\AffiliationType $affiliation)
    {
     ...
     * A Composite containing details of an affiliation for the Party.
     *
     * @return \DedexBundle\Entity\Ern431\AffiliationType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\RelatedPartyType $relatedParty
     */
    public function addToRelatedParty(\DedexBundle\Entity\Ern431\RelatedPartyType $relatedParty)
    {
     ...
     * A Composite containing details of a PartyRelatedPartyReference referring to a Party that is related to the current Party. This can be used to express, for instance, relationships between a band and its members or between a label and its parent company.
     *
     * @return \DedexBundle\Entity\Ern431\RelatedPartyType[]
     */

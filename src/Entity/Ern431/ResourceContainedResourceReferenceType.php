...
class ResourceContainedResourceReferenceType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PurposeType $purpose
     */
     ...
     * A Composite containing details of the Purpose of the usage.
     *
     * @return \DedexBundle\Entity\Ern431\PurposeType
     */
     ...
     * A Composite containing details of the Purpose of the usage.
     *
     * @param \DedexBundle\Entity\Ern431\PurposeType $purpose
     * @return self
     */
    public function setPurpose(?\DedexBundle\Entity\Ern431\PurposeType $purpose = null)
    {

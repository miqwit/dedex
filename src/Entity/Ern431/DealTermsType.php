...
class DealTermsType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\CurrentTerritoryCodeType[] $territoryCode
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\CurrentTerritoryCodeType[] $excludedTerritoryCode
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PeriodWithStartDateType[] $validityPeriod
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\CommercialModelTypeType[] $commercialModelType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\DiscoverableUseTypeType[] $useType
     */
    private $useType = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\UserInterfaceTypeType[] $userInterfaceType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\DealTermsTechnicalInstantiationType $technicalInstantiation
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\DSPType[] $distributionChannel
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\DSPType[] $excludedDistributionChannel
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\RightsClaimPolicyType[] $rightsClaimPolicy
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PriceInformationType[] $priceInformation
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PromotionalCodeType $promotionalCode
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\PhysicalReturnsType $physicalReturns
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\CurrentTerritoryCodeType $territoryCode
     */
    public function addToTerritoryCode(\DedexBundle\Entity\Ern431\CurrentTerritoryCodeType $territoryCode)
    {
     ...
     * A Territory in which the Deal applies. Either this Element or ExcludedTerritory must be present, but not both. The use of ISO TerritoryCodes (or the term 'Worldwide') is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
     * @return \DedexBundle\Entity\Ern431\CurrentTerritoryCodeType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\CurrentTerritoryCodeType $excludedTerritoryCode
     */
    public function addToExcludedTerritoryCode(\DedexBundle\Entity\Ern431\CurrentTerritoryCodeType $excludedTerritoryCode)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\PeriodWithStartDateType $validityPeriod
     */
    public function addToValidityPeriod(\DedexBundle\Entity\Ern431\PeriodWithStartDateType $validityPeriod)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/start-dates%2C-end-dates%2C-start-datetimes-and-end-datetimes
     *
     * @return \DedexBundle\Entity\Ern431\PeriodWithStartDateType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\CommercialModelTypeType $commercialModelType
     */
    public function addToCommercialModelType(\DedexBundle\Entity\Ern431\CommercialModelTypeType $commercialModelType)
    {
     ...
     * A Composite containing details of the fundamental business model which applies to the Deal (e.g. SubscriptionModel and PayAsYouGoModel). The CommercialModelType indicates how the Consumer pays for the Service or Release.
     *
     * @return \DedexBundle\Entity\Ern431\CommercialModelTypeType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\DiscoverableUseTypeType $useType
     */
    public function addToUseType(\DedexBundle\Entity\Ern431\DiscoverableUseTypeType $useType)
    {
     ...
     * A Composite containing details of a nature of a Service, or a Release, as used by a Consumer. The UseType is mandatory unless the terms of the Deal were communicated beforehand (possibly out of band) and then referenced using a DealReference.
     *
     * @return \DedexBundle\Entity\Ern431\DiscoverableUseTypeType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\UserInterfaceTypeType $userInterfaceType
     */
    public function addToUserInterfaceType(\DedexBundle\Entity\Ern431\UserInterfaceTypeType $userInterfaceType)
    {
     ...
     * A Composite containing details of a physical interface by which a Consumer uses a Service or Release.
     *
     * @return \DedexBundle\Entity\Ern431\UserInterfaceTypeType[]
     */
     ...
     * A Composite containing technical details of the Release.
     *
     * @return \DedexBundle\Entity\Ern431\DealTermsTechnicalInstantiationType
     */
     ...
     * A Composite containing technical details of the Release.
     *
     * @param \DedexBundle\Entity\Ern431\DealTermsTechnicalInstantiationType $technicalInstantiation
     * @return self
     */
    public function setTechnicalInstantiation(?\DedexBundle\Entity\Ern431\DealTermsTechnicalInstantiationType $technicalInstantiation = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\DSPType $distributionChannel
     */
    public function addToDistributionChannel(\DedexBundle\Entity\Ern431\DSPType $distributionChannel)
    {
     ...
     * A Composite containing details of the DSP through whose DistributionChannel the sales are permitted. If none are provided no limitations on the DistributionChannels are given.
     *
     * @return \DedexBundle\Entity\Ern431\DSPType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\DSPType $excludedDistributionChannel
     */
    public function addToExcludedDistributionChannel(\DedexBundle\Entity\Ern431\DSPType $excludedDistributionChannel)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\RightsClaimPolicyType $rightsClaimPolicy
     */
    public function addToRightsClaimPolicy(\DedexBundle\Entity\Ern431\RightsClaimPolicyType $rightsClaimPolicy)
    {
     ...
     * A Composite containing details of a rights claim policy.
     *
     * @return \DedexBundle\Entity\Ern431\RightsClaimPolicyType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\PriceInformationType $priceInformation
     */
    public function addToPriceInformation(\DedexBundle\Entity\Ern431\PriceInformationType $priceInformation)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/price-information
     *
     * @return \DedexBundle\Entity\Ern431\PriceInformationType[]
     */
     ...
     * A Composite containing details of a PromotionalCode.
     *
     * @return \DedexBundle\Entity\Ern431\PromotionalCodeType
     */
     ...
     * A Composite containing details of a PromotionalCode.
     *
     * @param \DedexBundle\Entity\Ern431\PromotionalCodeType $promotionalCode
     * @return self
     */
    public function setPromotionalCode(?\DedexBundle\Entity\Ern431\PromotionalCodeType $promotionalCode = null)
    {
     ...
     * A Composite containing details of physical returns.
     *
     * @return \DedexBundle\Entity\Ern431\PhysicalReturnsType
     */
     ...
     * A Composite containing details of physical returns.
     *
     * @param \DedexBundle\Entity\Ern431\PhysicalReturnsType $physicalReturns
     * @return self
     */
    public function setPhysicalReturns(?\DedexBundle\Entity\Ern431\PhysicalReturnsType $physicalReturns = null)
    {

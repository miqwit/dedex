...
class SupplementalDocumentListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\FileType[] $supplementalDocument
     */
     ...
     */
    public function addToSupplementalDocument(\DedexBundle\Entity\Ern431\FileType $supplementalDocument)
    {

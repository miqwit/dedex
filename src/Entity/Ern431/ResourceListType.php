...
class ResourceListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\SoundRecordingType[] $soundRecording
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern431\VideoType[] $video
     */
    private $video = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ImageType[] $image
     */
    private $image = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\TextType[] $text
     */
    private $text = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\SoftwareType[] $software
     */
    private $software = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DedexBundle\Entity\Ern431\SoundRecordingType $soundRecording)
    {
     ...
     * A Composite containing details of a SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern431\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\VideoType $video
     */
    public function addToVideo(\DedexBundle\Entity\Ern431\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     * A Composite containing details of a Video.
     *
     * @return \DedexBundle\Entity\Ern431\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\ImageType $image
     */
    public function addToImage(\DedexBundle\Entity\Ern431\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     * A Composite containing details of an Image.
     *
     * @return \DedexBundle\Entity\Ern431\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\TextType $text
     */
    public function addToText(\DedexBundle\Entity\Ern431\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     * A Composite containing details of a Text.
     *
     * @return \DedexBundle\Entity\Ern431\TextType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DedexBundle\Entity\Ern431\SheetMusicType $sheetMusic)
    {
     ...
     * A Composite containing details of a SheetMusic.
     *
     * @return \DedexBundle\Entity\Ern431\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\SoftwareType $software
     */
    public function addToSoftware(\DedexBundle\Entity\Ern431\SoftwareType $software)
    {
     ...
     * A Composite containing details of an item of Software.
     *
     * @return \DedexBundle\Entity\Ern431\SoftwareType[]
     */

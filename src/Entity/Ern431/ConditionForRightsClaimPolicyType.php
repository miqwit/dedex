...
class ConditionForRightsClaimPolicyType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern431\SegmentType[] $segment
     */
    private $segment = [
     ...
     *
     * @var \DedexBundle\Entity\Ern431\ServiceExceptionType[] $serviceException
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\SegmentType $segment
     */
    public function addToSegment(\DedexBundle\Entity\Ern431\SegmentType $segment)
    {
     ...
     * A Composite containing details of a segment of the Resource to which the Condition is applicable. If no segment is specified, the whole Resource is subject the RightsClaim Policy.
     *
     * @return \DedexBundle\Entity\Ern431\SegmentType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern431\ServiceExceptionType $serviceException
     */
    public function addToServiceException(\DedexBundle\Entity\Ern431\ServiceExceptionType $serviceException)
    {
     ...
     * A Composite containing details of a Service that is an exception to the Condition. For these exceptions, usage does not need to be reported for fingerprinting and web monitoring services.
     *
     * @return \DedexBundle\Entity\Ern431\ServiceExceptionType[]
     */

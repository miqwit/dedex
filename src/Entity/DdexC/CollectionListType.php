...
class CollectionListType
{
     ...
     *
     * @var \DedexBundle\Entity\DdexC\CollectionType[] $collection
     */
    private $collection = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\DdexC\CollectionType $collection
     */
    public function addToCollection(\DedexBundle\Entity\DdexC\CollectionType $collection)
    {
     ...
     * A ddex:Composite containing details of a ddex:Collection contained in a ddex:Resource.
     *
     * @return \DedexBundle\Entity\DdexC\CollectionType[]
     */

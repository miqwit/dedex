...
class TextDetailsByTerritoryType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern341\TechnicalTextDetailsType[] $technicalTextDetails
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern341\TechnicalTextDetailsType $technicalTextDetails
     */
    public function addToTechnicalTextDetails(\DedexBundle\Entity\Ern341\TechnicalTextDetailsType $technicalTextDetails)
    {
     ...
     * A ddex:Composite containing technical details of the ddex:Text.
     *
     * @return \DedexBundle\Entity\Ern341\TechnicalTextDetailsType[]
     */

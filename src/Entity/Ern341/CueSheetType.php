...
class CueSheetType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern341\CueType[] $cue
     */
    private $cue = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern341\CueType $cue
     */
    public function addToCue(\DedexBundle\Entity\Ern341\CueType $cue)
    {
        $this->cue[] = $cue;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Cue.
     *
     * @return \DedexBundle\Entity\Ern341\CueType[]
     */

...
class SoundRecordingDetailsByTerritoryType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern341\TechnicalSoundRecordingDetailsType[] $technicalSoundRecordingDetails
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern341\TechnicalSoundRecordingDetailsType $technicalSoundRecordingDetails
     */
    public function addToTechnicalSoundRecordingDetails(\DedexBundle\Entity\Ern341\TechnicalSoundRecordingDetailsType $technicalSoundRecordingDetails)
    {
     ...
     * A ddex:Composite containing technical details of the ddex:SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern341\TechnicalSoundRecordingDetailsType[]
     */

...
class CatalogListMessage
{
     ...
     *
     * @var \DedexBundle\Entity\Ern\CatalogItemType[] $catalogItem
     */
    private $catalogItem = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\CatalogItemType $catalogItem
     */
    public function addToCatalogItem(\DedexBundle\Entity\Ern\CatalogItemType $catalogItem)
    {
     ...
     *  Release which is an item of the catalog.
     *
     * @return \DedexBundle\Entity\Ern\CatalogItemType[]
     */

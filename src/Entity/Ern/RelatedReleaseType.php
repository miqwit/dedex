...
class RelatedReleaseType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern\ReleaseSummaryDetailsByTerritoryType[] $releaseSummaryDetailsByTerritory
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\ReleaseSummaryDetailsByTerritoryType $releaseSummaryDetailsByTerritory
     */
    public function addToReleaseSummaryDetailsByTerritory(\DedexBundle\Entity\Ern\ReleaseSummaryDetailsByTerritoryType $releaseSummaryDetailsByTerritory)
    {
     ...
     *  Territory of Release. Territory of Release may be the world.
     *
     * @return \DedexBundle\Entity\Ern\ReleaseSummaryDetailsByTerritoryType[]
     */

...
class RightsClaimPolicyType
{
     ...
     *  conditions.
     *
     * @var \DedexBundle\Entity\Ern\ConditionType[] $condition
     */
    private $condition = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\ConditionType $condition
     */
    public function addToCondition(\DedexBundle\Entity\Ern\ConditionType $condition)
    {
     ...
     *  conditions.
     *
     * @return \DedexBundle\Entity\Ern\ConditionType[]
     */

...
class CollectionListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern\CollectionType[] $collection
     */
    private $collection = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\CollectionType $collection
     */
    public function addToCollection(\DedexBundle\Entity\Ern\CollectionType $collection)
    {
     ...
     *  Collection contained in a Resource.
     *
     * @return \DedexBundle\Entity\Ern\CollectionType[]
     */

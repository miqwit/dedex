...
class DealTermsType
{
     ...
     *  applies.
     *
     * @var \DedexBundle\Entity\Ern\UsageType[] $usage
     */
    private $usage = [
     ...
     *  Composite.
     *
     * @var \DedexBundle\Entity\Ern\PriceInformationType[] $priceInformation
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\ConsumerRentalPeriodType $consumerRentalPeriod
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\EventDateType $preOrderReleaseDate
     */
     ...
     *  YYYY[-MM[-DD]].
     *
     * @var \DedexBundle\Entity\Ern\EventDateType $preOrderPreviewDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\DealResourceReferenceListType $preOrderIncentiveResourceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\DealResourceReferenceListType $instantGratificationResourceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\RelatedReleaseOfferSetType[] $relatedReleaseOfferSet
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\WebPolicyType[] $webPolicy
     */
    private $webPolicy = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\UsageType $usage
     */
    public function addToUsage(\DedexBundle\Entity\Ern\UsageType $usage)
    {
        $this->usage[] = $usage;
        return $this;
    }
     ...
     *  applies.
     *
     * @return \DedexBundle\Entity\Ern\UsageType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\PriceInformationType $priceInformation
     */
    public function addToPriceInformation(\DedexBundle\Entity\Ern\PriceInformationType $priceInformation)
    {
     ...
     *  Composite.
     *
     * @return \DedexBundle\Entity\Ern\PriceInformationType[]
     */
     ...
     */
    public function addToValidityPeriod(\DedexBundle\Entity\Ern\PeriodType $validityPeriod)
    {
     ...
     *  the DSP may rent something to a Customer.
     *
     * @return \DedexBundle\Entity\Ern\ConsumerRentalPeriodType
     */
     ...
     *  the DSP may rent something to a Customer.
     *
     * @param \DedexBundle\Entity\Ern\ConsumerRentalPeriodType $consumerRentalPeriod
     * @return self
     */
    public function setConsumerRentalPeriod(\DedexBundle\Entity\Ern\ConsumerRentalPeriodType $consumerRentalPeriod)
    {
     ...
     *  with the syntax YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern\EventDateType $preOrderReleaseDate
     * @return self
     */
    public function setPreOrderReleaseDate(\DedexBundle\Entity\Ern\EventDateType $preOrderReleaseDate)
    {
     ...
     *  YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern\EventDateType $preOrderPreviewDate
     * @return self
     */
    public function setPreOrderPreviewDate(\DedexBundle\Entity\Ern\EventDateType $preOrderPreviewDate)
    {
     ...
     *  pre-order period (delivery is typically at ReleaseDate).
     *
     * @return \DedexBundle\Entity\Ern\DealResourceReferenceListType
     */
     ...
     *  pre-order period (delivery is typically at ReleaseDate).
     *
     * @param \DedexBundle\Entity\Ern\DealResourceReferenceListType $preOrderIncentiveResourceList
     * @return self
     */
    public function setPreOrderIncentiveResourceList(\DedexBundle\Entity\Ern\DealResourceReferenceListType $preOrderIncentiveResourceList)
    {
     ...
     *  purchased (i.e. before the ReleaseDate).
     *
     * @param \DedexBundle\Entity\Ern\DealResourceReferenceListType $instantGratificationResourceList
     * @return self
     */
    public function setInstantGratificationResourceList(\DedexBundle\Entity\Ern\DealResourceReferenceListType $instantGratificationResourceList)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\RelatedReleaseOfferSetType $relatedReleaseOfferSet
     */
    public function addToRelatedReleaseOfferSet(\DedexBundle\Entity\Ern\RelatedReleaseOfferSetType $relatedReleaseOfferSet)
    {
     ...
     *  more offers related to the Release.
     *
     * @return \DedexBundle\Entity\Ern\RelatedReleaseOfferSetType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\WebPolicyType $webPolicy
     */
    public function addToWebPolicy(\DedexBundle\Entity\Ern\WebPolicyType $webPolicy)
    {
     ...
     *  UserGeneratedContent permissions.
     *
     * @return \DedexBundle\Entity\Ern\WebPolicyType[]
     */

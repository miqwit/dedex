...
class ReleaseCollectionReferenceListType
{
     ...
     *  Episode.
     *
     * @var \DedexBundle\Entity\Ern\ReleaseCollectionReferenceType[] $releaseCollectionReference
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\ReleaseCollectionReferenceType $releaseCollectionReference
     */
    public function addToReleaseCollectionReference(\DedexBundle\Entity\Ern\ReleaseCollectionReferenceType $releaseCollectionReference)
    {
     ...
     *  Episode.
     *
     * @return \DedexBundle\Entity\Ern\ReleaseCollectionReferenceType[]
     */

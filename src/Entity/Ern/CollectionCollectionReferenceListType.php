...
class CollectionCollectionReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern\CollectionCollectionReferenceType[] $collectionCollectionReference
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\CollectionCollectionReferenceType $collectionCollectionReference
     */
    public function addToCollectionCollectionReference(\DedexBundle\Entity\Ern\CollectionCollectionReferenceType $collectionCollectionReference)
    {
     ...
     *  Message).
     *
     * @return \DedexBundle\Entity\Ern\CollectionCollectionReferenceType[]
     */

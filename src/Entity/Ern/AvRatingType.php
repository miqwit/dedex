...
class AvRatingType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern\RatingAgencyType $ratingAgency
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\DescriptionType[] $ratingSchemeDescription
     */
     ...
     *  Organization that issues the AvRating.
     *
     * @param \DedexBundle\Entity\Ern\RatingAgencyType $ratingAgency
     * @return self
     */
    public function setRatingAgency(\DedexBundle\Entity\Ern\RatingAgencyType $ratingAgency)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\DescriptionType $ratingSchemeDescription
     */
    public function addToRatingSchemeDescription(\DedexBundle\Entity\Ern\DescriptionType $ratingSchemeDescription)
    {

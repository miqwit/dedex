...
class SoundRecordingCollectionReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern\SoundRecordingCollectionReferenceType[] $soundRecordingCollectionReference
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference
     */
    public function addToSoundRecordingCollectionReference(\DedexBundle\Entity\Ern\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference)
    {
     ...
     *  Message).
     *
     * @return \DedexBundle\Entity\Ern\SoundRecordingCollectionReferenceType[]
     */

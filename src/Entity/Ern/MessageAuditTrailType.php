...
class MessageAuditTrailType
{
     ...
     *  place.
     *
     * @var \DedexBundle\Entity\Ern\MessageAuditTrailEventType[] $messageAuditTrailEvent
     */
     ...
     */
    public function addToMessageAuditTrailEvent(\DedexBundle\Entity\Ern\MessageAuditTrailEventType $messageAuditTrailEvent)
    {

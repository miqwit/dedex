...
class PriceInformationType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern\PriceTypeType $priceType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\DescriptionType $description
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\PriceRangeTypeType $priceRangeType
     */
     ...
     *  BulkOrderWholesalePricePerUnit.
     *
     * @param \DedexBundle\Entity\Ern\PriceTypeType $priceType
     * @return self
     */
    public function setPriceType(\DedexBundle\Entity\Ern\PriceTypeType $priceType)
    {
     ...
     *  the differences between multiple PriceInformation Composites.
     *
     * @param \DedexBundle\Entity\Ern\DescriptionType $description
     * @return self
     */
    public function setDescription(\DedexBundle\Entity\Ern\DescriptionType $description)
    {
     ...
     *  on the Price to be used by the DSP.
     *
     * @return \DedexBundle\Entity\Ern\PriceRangeTypeType
     */
     ...
     *  on the Price to be used by the DSP.
     *
     * @param \DedexBundle\Entity\Ern\PriceRangeTypeType $priceRangeType
     * @return self
     */
    public function setPriceRangeType(\DedexBundle\Entity\Ern\PriceRangeTypeType $priceRangeType)
    {

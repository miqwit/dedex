...
class MusicalWorkContributorType
{
     ...
     *  MusicalWork.
     *
     * @var \DedexBundle\Entity\Ern\MusicalWorkContributorRoleType[] $musicalWorkContributorRole
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\SocietyAffiliationType[] $societyAffiliation
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\MusicalWorkContributorRoleType $musicalWorkContributorRole
     */
    public function addToMusicalWorkContributorRole(\DedexBundle\Entity\Ern\MusicalWorkContributorRoleType $musicalWorkContributorRole)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\SocietyAffiliationType $societyAffiliation
     */
    public function addToSocietyAffiliation(\DedexBundle\Entity\Ern\SocietyAffiliationType $societyAffiliation)
    {
     ...
     *  society affiliation for the MusicalWorkContributor.
     *
     * @return \DedexBundle\Entity\Ern\SocietyAffiliationType[]
     */

...
class CollectionIdType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern382\ICPNType $iCPN
     */
    private $iCPN = null;
     ...
     *  the syntax [0-9]{12,13} using XML Schema in the future.
     *
     * @return \DedexBundle\Entity\Ern382\ICPNType
     */
     ...
     *  the syntax [0-9]{12,13} using XML Schema in the future.
     *
     * @param \DedexBundle\Entity\Ern382\ICPNType $iCPN
     * @return self
     */
    public function setICPN(\DedexBundle\Entity\Ern382\ICPNType $iCPN)
    {
        $this->iCPN = $iCPN;
        return $this;
    }

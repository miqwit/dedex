...
class ResourceListType
{
     ...
     *  SoundRecording.
     *
     * @var \DedexBundle\Entity\Ern382\SoundRecordingType[] $soundRecording
     */
     ...
     *  MIDI.
     *
     * @var \DedexBundle\Entity\Ern382\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *  Video.
     *
     * @var \DedexBundle\Entity\Ern382\VideoType[] $video
     */
    private $video = [
     ...
     *  Image.
     *
     * @var \DedexBundle\Entity\Ern382\ImageType[] $image
     */
    private $image = [
     ...
     *  Text.
     *
     * @var \DedexBundle\Entity\Ern382\TextType[] $text
     */
    private $text = [
     ...
     *  SheetMusic.
     *
     * @var \DedexBundle\Entity\Ern382\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *  of Software.
     *
     * @var \DedexBundle\Entity\Ern382\SoftwareType[] $software
     */
    private $software = [
     ...
     *  UserDefinedResource.
     *
     * @var \DedexBundle\Entity\Ern382\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern382\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DedexBundle\Entity\Ern382\SoundRecordingType $soundRecording)
    {
     ...
     *  SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern382\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern382\MIDIType $mIDI
     */
    public function addToMIDI(\DedexBundle\Entity\Ern382\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     *  MIDI.
     *
     * @return \DedexBundle\Entity\Ern382\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern382\VideoType $video
     */
    public function addToVideo(\DedexBundle\Entity\Ern382\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     *  Video.
     *
     * @return \DedexBundle\Entity\Ern382\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern382\ImageType $image
     */
    public function addToImage(\DedexBundle\Entity\Ern382\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     *  Image.
     *
     * @return \DedexBundle\Entity\Ern382\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern382\TextType $text
     */
    public function addToText(\DedexBundle\Entity\Ern382\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     *  Text.
     *
     * @return \DedexBundle\Entity\Ern382\TextType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern382\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DedexBundle\Entity\Ern382\SheetMusicType $sheetMusic)
    {
     ...
     *  SheetMusic.
     *
     * @return \DedexBundle\Entity\Ern382\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern382\SoftwareType $software
     */
    public function addToSoftware(\DedexBundle\Entity\Ern382\SoftwareType $software)
    {
     ...
     *  of Software.
     *
     * @return \DedexBundle\Entity\Ern382\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern382\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DedexBundle\Entity\Ern382\UserDefinedResourceType $userDefinedResource)
    {
     ...
     *  UserDefinedResource.
     *
     * @return \DedexBundle\Entity\Ern382\UserDefinedResourceType[]
     */

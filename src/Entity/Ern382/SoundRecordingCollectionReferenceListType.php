...
class SoundRecordingCollectionReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern382\SoundRecordingCollectionReferenceType[] $soundRecordingCollectionReference
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern382\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference
     */
    public function addToSoundRecordingCollectionReference(\DedexBundle\Entity\Ern382\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference)
    {
     ...
     *  Message).
     *
     * @return \DedexBundle\Entity\Ern382\SoundRecordingCollectionReferenceType[]
     */

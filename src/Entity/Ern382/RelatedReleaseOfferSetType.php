...
class RelatedReleaseOfferSetType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern382\DescriptionType $releaseDescription
     */
     ...
     *  Release.
     *
     * @var \DedexBundle\Entity\Ern382\DealType[] $deal
     */
    private $deal = [
     ...
     *  list individual Releases by xs:ID or Title.
     *
     * @param \DedexBundle\Entity\Ern382\DescriptionType $releaseDescription
     * @return self
     */
    public function setReleaseDescription(\DedexBundle\Entity\Ern382\DescriptionType $releaseDescription)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern382\DealType $deal
     */
    public function addToDeal(\DedexBundle\Entity\Ern382\DealType $deal)
    {
        $this->deal[] = $deal;
        return $this;
    }
     ...
     *  Release.
     *
     * @return \DedexBundle\Entity\Ern382\DealType[]
     */

...
class CatalogListMessage
{
     ...
     *
     * @var \DedexBundle\Entity\Ern382\CatalogItemType[] $catalogItem
     */
    private $catalogItem = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern382\CatalogItemType $catalogItem
     */
    public function addToCatalogItem(\DedexBundle\Entity\Ern382\CatalogItemType $catalogItem)
    {
     ...
     *  Release which is an item of the catalog.
     *
     * @return \DedexBundle\Entity\Ern382\CatalogItemType[]
     */

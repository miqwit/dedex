...
class ArtistType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern382\ArtistRoleType[] $artistRole
     */
    private $artistRole = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern382\ArtistRoleType $artistRole
     */
    public function addToArtistRole(\DedexBundle\Entity\Ern382\ArtistRoleType $artistRole)
    {

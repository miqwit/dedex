...
class RelatedResourceType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern\TimingType[] $timing
     */
    private $timing = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\TimingType $timing
     */
    public function addToTiming(\DedexBundle\Entity\Ern\TimingType $timing)
    {
        $this->timing[] = $timing;
        return $this;
    }
     ...
     * A Composite containing details of a StartTime and/or a Duration of the related Resource.
     *
     * @return \DedexBundle\Entity\Ern\TimingType[]
     */

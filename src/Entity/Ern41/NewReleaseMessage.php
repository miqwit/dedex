...
class NewReleaseMessage
{
     ...
     *
     * @var \DedexBundle\Entity\Ern\PartyType[] $partyList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\DetailedCueSheetType[] $cueSheetList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\ResourceListType $resourceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\ChapterListType $chapterList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\ReleaseListType $releaseList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\ReleaseDealType[] $dealList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern\FileType[] $supplementalDocumentList
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\PartyType $party
     */
    public function addToPartyList(\DedexBundle\Entity\Ern\PartyType $party)
    {
     ...
     * A Composite containing details of one or more Parties relating to the reported MusicalWorks.
     *
     * @return \DedexBundle\Entity\Ern\PartyType[]
     */
     ...
     * A Composite containing details of one or more Parties relating to the reported MusicalWorks.
     *
     * @param \DedexBundle\Entity\Ern\PartyType[] $partyList
     * @return self
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\DetailedCueSheetType $cueSheet
     */
    public function addToCueSheetList(\DedexBundle\Entity\Ern\DetailedCueSheetType $cueSheet)
    {
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @return \DedexBundle\Entity\Ern\DetailedCueSheetType[]
     */
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @param \DedexBundle\Entity\Ern\DetailedCueSheetType[] $cueSheetList
     * @return self
     */
     ...
     * A Composite containing details of one or more Resources.
     *
     * @return \DedexBundle\Entity\Ern\ResourceListType
     */
     ...
     * A Composite containing details of one or more Resources.
     *
     * @param \DedexBundle\Entity\Ern\ResourceListType $resourceList
     * @return self
     */
    public function setResourceList(\DedexBundle\Entity\Ern\ResourceListType $resourceList)
    {
     ...
     * A Composite containing details of one or more Chapters contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @return \DedexBundle\Entity\Ern\ChapterListType
     */
     ...
     * A Composite containing details of one or more Chapters contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @param \DedexBundle\Entity\Ern\ChapterListType $chapterList
     * @return self
     */
    public function setChapterList(\DedexBundle\Entity\Ern\ChapterListType $chapterList)
    {
     ...
     * A Composite containing details of one or more DDEX Releases contained in the NewReleaseMessage.
     *
     * @return \DedexBundle\Entity\Ern\ReleaseListType
     */
     ...
     * A Composite containing details of one or more DDEX Releases contained in the NewReleaseMessage.
     *
     * @param \DedexBundle\Entity\Ern\ReleaseListType $releaseList
     * @return self
     */
    public function setReleaseList(\DedexBundle\Entity\Ern\ReleaseListType $releaseList)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\ReleaseDealType $releaseDeal
     */
    public function addToDealList(\DedexBundle\Entity\Ern\ReleaseDealType $releaseDeal)
    {
     ...
     * A Composite containing details of one or more Deals governing the Usage of the Releases in the Message.
     *
     * @return \DedexBundle\Entity\Ern\ReleaseDealType[]
     */
     ...
     * A Composite containing details of one or more Deals governing the Usage of the Releases in the Message.
     *
     * @param \DedexBundle\Entity\Ern\ReleaseDealType[] $dealList
     * @return self
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern\FileType $supplementalDocument
     */
    public function addToSupplementalDocumentList(\DedexBundle\Entity\Ern\FileType $supplementalDocument)
    {
     ...
     * A Composite containing details of one or more XML documents communicated with the Message.
     *
     * @param \DedexBundle\Entity\Ern\FileType[] $supplementalDocumentList
     * @return self
     */

...
class ResourceMusicalWorkReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern383\ResourceMusicalWorkReferenceType[] $resourceMusicalWorkReference
     */
     ...
     */
    public function addToResourceMusicalWorkReference(\DedexBundle\Entity\Ern383\ResourceMusicalWorkReferenceType $resourceMusicalWorkReference)
    {

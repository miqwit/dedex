...
class AvRatingType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern383\RatingAgencyType $ratingAgency
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern383\DescriptionType[] $ratingSchemeDescription
     */
     ...
     *  Organization that issues the AvRating.
     *
     * @return \DedexBundle\Entity\Ern383\RatingAgencyType
     */
     ...
     *  Organization that issues the AvRating.
     *
     * @param \DedexBundle\Entity\Ern383\RatingAgencyType $ratingAgency
     * @return self
     */
    public function setRatingAgency(\DedexBundle\Entity\Ern383\RatingAgencyType $ratingAgency)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern383\DescriptionType $ratingSchemeDescription
     */
    public function addToRatingSchemeDescription(\DedexBundle\Entity\Ern383\DescriptionType $ratingSchemeDescription)
    {

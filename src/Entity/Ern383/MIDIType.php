...
class MIDIType
{
     ...
     *  of the MIDI.
     *
     * @var \DedexBundle\Entity\Ern383\MidiTypeType $midiType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern383\ResourceProprietaryIdType[] $midiId
     */
    private $midiId = [
     ...
     *
     * @var \DedexBundle\Entity\Ern383\MusicalWorkIdType[] $indirectMidiId
     */
     ...
     *  of release.
     *
     * @var \DedexBundle\Entity\Ern383\MidiDetailsByTerritoryType[] $midiDetailsByTerritory
     */
     ...
     *  of the MIDI.
     *
     * @return \DedexBundle\Entity\Ern383\MidiTypeType
     */
     ...
     *  of the MIDI.
     *
     * @param \DedexBundle\Entity\Ern383\MidiTypeType $midiType
     * @return self
     */
    public function setMidiType(?\DedexBundle\Entity\Ern383\MidiTypeType $midiType = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern383\ResourceProprietaryIdType $midiId
     */
    public function addToMidiId(\DedexBundle\Entity\Ern383\ResourceProprietaryIdType $midiId)
    {
        $this->midiId[] = $midiId;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern383\MusicalWorkIdType $indirectMidiId
     */
    public function addToIndirectMidiId(\DedexBundle\Entity\Ern383\MusicalWorkIdType $indirectMidiId)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern383\MidiDetailsByTerritoryType $midiDetailsByTerritory
     */
    public function addToMidiDetailsByTerritory(\DedexBundle\Entity\Ern383\MidiDetailsByTerritoryType $midiDetailsByTerritory)
    {
     ...
     *  of release.
     *
     * @return \DedexBundle\Entity\Ern383\MidiDetailsByTerritoryType[]
     */

...
class RightsClaimPolicyType
{
     ...
     *  conditions.
     *
     * @var \DedexBundle\Entity\Ern383\ConditionType[] $condition
     */
    private $condition = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern383\ConditionType $condition
     */
    public function addToCondition(\DedexBundle\Entity\Ern383\ConditionType $condition)
    {
     ...
     *  conditions.
     *
     * @return \DedexBundle\Entity\Ern383\ConditionType[]
     */

...
class CollectionResourceReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern383\CollectionResourceReferenceType[] $collectionResourceReference
     */
     ...
     */
    public function addToCollectionResourceReference(\DedexBundle\Entity\Ern383\CollectionResourceReferenceType $collectionResourceReference)
    {

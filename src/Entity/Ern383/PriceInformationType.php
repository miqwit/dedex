...
class PriceInformationType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern383\PriceTypeType $priceType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern383\DescriptionType $description
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern383\PriceRangeTypeType $priceRangeType
     */
     ...
     *  with PriceType.
     *
     * @var \DedexBundle\Entity\Ern383\PriceType $wholesalePricePerUnit
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern383\PriceType $bulkOrderWholesalePricePerUnit
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern383\PriceType $suggestedRetailPrice
     */
     ...
     *  BulkOrderWholesalePricePerUnit.
     *
     * @return \DedexBundle\Entity\Ern383\PriceTypeType
     */
     ...
     *  BulkOrderWholesalePricePerUnit.
     *
     * @param \DedexBundle\Entity\Ern383\PriceTypeType $priceType
     * @return self
     */
    public function setPriceType(?\DedexBundle\Entity\Ern383\PriceTypeType $priceType = null)
    {
     ...
     *  the differences between multiple PriceInformation Composites.
     *
     * @param \DedexBundle\Entity\Ern383\DescriptionType $description
     * @return self
     */
    public function setDescription(?\DedexBundle\Entity\Ern383\DescriptionType $description = null)
    {
     ...
     *  on the Price to be used by the DSP.
     *
     * @return \DedexBundle\Entity\Ern383\PriceRangeTypeType
     */
     ...
     *  on the Price to be used by the DSP.
     *
     * @param \DedexBundle\Entity\Ern383\PriceRangeTypeType $priceRangeType
     * @return self
     */
    public function setPriceRangeType(?\DedexBundle\Entity\Ern383\PriceRangeTypeType $priceRangeType = null)
    {
     ...
     *  with PriceType.
     *
     * @return \DedexBundle\Entity\Ern383\PriceType
     */
     ...
     *  with PriceType.
     *
     * @param \DedexBundle\Entity\Ern383\PriceType $wholesalePricePerUnit
     * @return self
     */
    public function setWholesalePricePerUnit(?\DedexBundle\Entity\Ern383\PriceType $wholesalePricePerUnit = null)
    {
     ...
     *  not be combined with PriceType.
     *
     * @param \DedexBundle\Entity\Ern383\PriceType $bulkOrderWholesalePricePerUnit
     * @return self
     */
    public function setBulkOrderWholesalePricePerUnit(?\DedexBundle\Entity\Ern383\PriceType $bulkOrderWholesalePricePerUnit = null)
    {
     ...
     *  suggested retail Price.
     *
     * @param \DedexBundle\Entity\Ern383\PriceType $suggestedRetailPrice
     * @return self
     */
    public function setSuggestedRetailPrice(?\DedexBundle\Entity\Ern383\PriceType $suggestedRetailPrice = null)
    {

...
class CueSheetType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern383\ProprietaryIdType[] $cueSheetId
     */
    private $cueSheetId = [
     ...
     *  of the CueSheet.
     *
     * @var \DedexBundle\Entity\Ern383\CueSheetTypeType $cueSheetType
     */
     ...
     *  Cue.
     *
     * @var \DedexBundle\Entity\Ern383\CueType[] $cue
     */
    private $cue = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern383\ProprietaryIdType $cueSheetId
     */
    public function addToCueSheetId(\DedexBundle\Entity\Ern383\ProprietaryIdType $cueSheetId)
    {
     ...
     *  of the CueSheet.
     *
     * @return \DedexBundle\Entity\Ern383\CueSheetTypeType
     */
     ...
     *  of the CueSheet.
     *
     * @param \DedexBundle\Entity\Ern383\CueSheetTypeType $cueSheetType
     * @return self
     */
    public function setCueSheetType(\DedexBundle\Entity\Ern383\CueSheetTypeType $cueSheetType)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern383\CueType $cue
     */
    public function addToCue(\DedexBundle\Entity\Ern383\CueType $cue)
    {
        $this->cue[] = $cue;
        return $this;
    }
     ...
     *  Cue.
     *
     * @return \DedexBundle\Entity\Ern383\CueType[]
     */

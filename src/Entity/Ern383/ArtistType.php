...
class ArtistType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern383\ArtistRoleType[] $artistRole
     */
    private $artistRole = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern383\ArtistRoleType $artistRole
     */
    public function addToArtistRole(\DedexBundle\Entity\Ern383\ArtistRoleType $artistRole)
    {

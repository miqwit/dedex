...
class CollectionCollectionReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern383\CollectionCollectionReferenceType[] $collectionCollectionReference
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern383\CollectionCollectionReferenceType $collectionCollectionReference
     */
    public function addToCollectionCollectionReference(\DedexBundle\Entity\Ern383\CollectionCollectionReferenceType $collectionCollectionReference)
    {
     ...
     *  Message).
     *
     * @return \DedexBundle\Entity\Ern383\CollectionCollectionReferenceType[]
     */

...
class DealResourceReferenceListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern383\PeriodType $period
     */
    private $period = null;
     ...
     *  Period of Time applicable to the Resources.
     *
     * @param \DedexBundle\Entity\Ern383\PeriodType $period
     * @return self
     */
    public function setPeriod(?\DedexBundle\Entity\Ern383\PeriodType $period = null)
    {
        $this->period = $period;
        return $this;
    }

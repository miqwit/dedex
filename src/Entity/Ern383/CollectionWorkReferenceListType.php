...
class CollectionWorkReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern383\CollectionWorkReferenceType[] $collectionWorkReference
     */
     ...
     */
    public function addToCollectionWorkReference(\DedexBundle\Entity\Ern383\CollectionWorkReferenceType $collectionWorkReference)
    {

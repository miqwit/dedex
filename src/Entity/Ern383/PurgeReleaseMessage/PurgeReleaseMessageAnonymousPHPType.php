...
namespace DedexBundle\Entity\Ern383\PurgeReleaseMessage;
...
class PurgeReleaseMessageAnonymousPHPType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern383\PurgedReleaseType $purgedRelease
     */
     ...
     *  DDEX Release to be purged.
     *
     * @return \DedexBundle\Entity\Ern383\PurgedReleaseType
     */
     ...
     *  DDEX Release to be purged.
     *
     * @param \DedexBundle\Entity\Ern383\PurgedReleaseType $purgedRelease
     * @return self
     */
    public function setPurgedRelease(\DedexBundle\Entity\Ern383\PurgedReleaseType $purgedRelease)
    {

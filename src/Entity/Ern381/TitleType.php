...
class TitleType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\TitleTextType $titleText
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\TypedSubTitleType[] $subTitle
     */
    private $subTitle = [
     ...
     * A Composite containing the text of the Title.
     *
     * @return \DedexBundle\Entity\Ern381\TitleTextType
     */
     ...
     * A Composite containing the text of the Title.
     *
     * @param \DedexBundle\Entity\Ern381\TitleTextType $titleText
     * @return self
     */
    public function setTitleText(\DedexBundle\Entity\Ern381\TitleTextType $titleText)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\TypedSubTitleType $subTitle
     */
    public function addToSubTitle(\DedexBundle\Entity\Ern381\TypedSubTitleType $subTitle)
    {
     ...
     * A Composite containing details of a SubTitle of the Title, including Titles of Versions used to differentiate different versions of the same Title, as required by the GRid and ISRC ReferenceDescriptiveMetadataSets.
     *
     * @return \DedexBundle\Entity\Ern381\TypedSubTitleType[]
     */

...
class CollectionType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CollectionIdType[] $collectionId
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CollectionTypeType[] $collectionType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\DetailedResourceContributorType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CollectionCollectionReferenceListType $collectionCollectionReferenceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\EventDateType $releaseDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\EventDateType $originalReleaseDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CollectionDetailsByTerritoryType[] $collectionDetailsByTerritory
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CollectionResourceReferenceType[] $collectionResourceReferenceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CollectionWorkReferenceType[] $collectionWorkReferenceList
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\CollectionIdType $collectionId
     */
    public function addToCollectionId(\DedexBundle\Entity\Ern381\CollectionIdType $collectionId)
    {
     ...
     * A Composite containing details of an Identifier of the Collection.
     *
     * @return \DedexBundle\Entity\Ern381\CollectionIdType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\CollectionTypeType $collectionType
     */
    public function addToCollectionType(\DedexBundle\Entity\Ern381\CollectionTypeType $collectionType)
    {
     ...
     * A Composite containing details of the Type of the Collection.
     *
     * @return \DedexBundle\Entity\Ern381\CollectionTypeType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\DetailedResourceContributorType $contributor
     */
    public function addToContributor(\DedexBundle\Entity\Ern381\DetailedResourceContributorType $contributor)
    {
     ...
     * A Composite containing a list of CollectionCollectionReferences for a Collection (specific to this Message).
     *
     * @return \DedexBundle\Entity\Ern381\CollectionCollectionReferenceListType
     */
     ...
     * A Composite containing a list of CollectionCollectionReferences for a Collection (specific to this Message).
     *
     * @param \DedexBundle\Entity\Ern381\CollectionCollectionReferenceListType $collectionCollectionReferenceList
     * @return self
     */
    public function setCollectionCollectionReferenceList(?\DedexBundle\Entity\Ern381\CollectionCollectionReferenceListType $collectionCollectionReferenceList = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Collection was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @param \DedexBundle\Entity\Ern381\EventDateType $releaseDate
     * @return self
     */
    public function setReleaseDate(?\DedexBundle\Entity\Ern381\EventDateType $releaseDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Collection was or will be first made available for Usage, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @param \DedexBundle\Entity\Ern381\EventDateType $originalReleaseDate
     * @return self
     */
    public function setOriginalReleaseDate(?\DedexBundle\Entity\Ern381\EventDateType $originalReleaseDate = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\CollectionDetailsByTerritoryType $collectionDetailsByTerritory
     */
    public function addToCollectionDetailsByTerritory(\DedexBundle\Entity\Ern381\CollectionDetailsByTerritoryType $collectionDetailsByTerritory)
    {
     ...
     * A Composite containing details of Descriptors and other attributes of the Collection which may vary according to Territory of release.
     *
     * @return \DedexBundle\Entity\Ern381\CollectionDetailsByTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\CollectionResourceReferenceType $collectionResourceReference
     */
    public function addToCollectionResourceReferenceList(\DedexBundle\Entity\Ern381\CollectionResourceReferenceType $collectionResourceReference)
    {
     ...
     * A Composite containing a list of CollectionResourceReferences for a Resource (specific to this Message).
     *
     * @return \DedexBundle\Entity\Ern381\CollectionResourceReferenceType[]
     */
     ...
     * A Composite containing a list of CollectionResourceReferences for a Resource (specific to this Message).
     *
     * @param \DedexBundle\Entity\Ern381\CollectionResourceReferenceType[] $collectionResourceReferenceList
     * @return self
     */
     ...
     */
    public function addToCollectionWorkReferenceList(\DedexBundle\Entity\Ern381\CollectionWorkReferenceType $collectionWorkReference)
    {
     ...
     * A Composite containing a list of CollectionWorkReferences for a Work (specific to this Message).
     *
     * @param \DedexBundle\Entity\Ern381\CollectionWorkReferenceType[] $collectionWorkReferenceList
     * @return self
     */

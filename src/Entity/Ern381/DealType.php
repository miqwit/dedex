...
class DealType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\DealReferenceType[] $dealReference
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\DealTermsType $dealTerms
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ResourceUsageType $resourceUsage
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\WebPageType[] $distributionChannelPage
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\DealReferenceType $dealReference
     */
    public function addToDealReference(\DedexBundle\Entity\Ern381\DealReferenceType $dealReference)
    {
     ...
     * A Composite containing a Reference to a TextDocument containing details of the Deal (in the form of an Identifier, Name or Description).
     *
     * @return \DedexBundle\Entity\Ern381\DealReferenceType[]
     */
     ...
     * A Composite containing details of the terms of the Deal.
     *
     * @return \DedexBundle\Entity\Ern381\DealTermsType
     */
     ...
     * A Composite containing details of the terms of the Deal.
     *
     * @param \DedexBundle\Entity\Ern381\DealTermsType $dealTerms
     * @return self
     */
    public function setDealTerms(?\DedexBundle\Entity\Ern381\DealTermsType $dealTerms = null)
    {
     ...
     * A Composite containing details of one or more Usages that govern a Resource in the Deal where the Usage of the Resource differs from the Usage of the other Resources in the same Release.
     *
     * @return \DedexBundle\Entity\Ern381\ResourceUsageType
     */
     ...
     * A Composite containing details of one or more Usages that govern a Resource in the Deal where the Usage of the Resource differs from the Usage of the other Resources in the same Release.
     *
     * @param \DedexBundle\Entity\Ern381\ResourceUsageType $resourceUsage
     * @return self
     */
    public function setResourceUsage(?\DedexBundle\Entity\Ern381\ResourceUsageType $resourceUsage = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\WebPageType $distributionChannelPage
     */
    public function addToDistributionChannelPage(\DedexBundle\Entity\Ern381\WebPageType $distributionChannelPage)
    {

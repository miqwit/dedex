...
class ReleaseListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ReleaseType[] $release
     */
    private $release = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ReleaseType $release
     */
    public function addToRelease(\DedexBundle\Entity\Ern381\ReleaseType $release)
    {
     ...
     * A Composite containing details of a DDEX Release.
     *
     * @return \DedexBundle\Entity\Ern381\ReleaseType[]
     */

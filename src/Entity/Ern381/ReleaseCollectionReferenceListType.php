...
class ReleaseCollectionReferenceListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ReleaseCollectionReferenceType[] $releaseCollectionReference
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ReleaseCollectionReferenceType $releaseCollectionReference
     */
    public function addToReleaseCollectionReference(\DedexBundle\Entity\Ern381\ReleaseCollectionReferenceType $releaseCollectionReference)
    {
     ...
     * A Composite containing a ReleaseCollectionReference for a Collection (specific to this Message). The referenced Collection has to be of CollectionType Series, Season or Episode.
     *
     * @return \DedexBundle\Entity\Ern381\ReleaseCollectionReferenceType[]
     */

...
class CueSheetType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ProprietaryIdType[] $cueSheetId
     */
    private $cueSheetId = [
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CueSheetTypeType $cueSheetType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CueType[] $cue
     */
    private $cue = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ProprietaryIdType $cueSheetId
     */
    public function addToCueSheetId(\DedexBundle\Entity\Ern381\ProprietaryIdType $cueSheetId)
    {
     ...
     * A Composite containing details of a Type of the CueSheet.
     *
     * @return \DedexBundle\Entity\Ern381\CueSheetTypeType
     */
     ...
     * A Composite containing details of a Type of the CueSheet.
     *
     * @param \DedexBundle\Entity\Ern381\CueSheetTypeType $cueSheetType
     * @return self
     */
    public function setCueSheetType(\DedexBundle\Entity\Ern381\CueSheetTypeType $cueSheetType)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\CueType $cue
     */
    public function addToCue(\DedexBundle\Entity\Ern381\CueType $cue)
    {
        $this->cue[] = $cue;
        return $this;
    }
     ...
     * A Composite containing details of a Cue.
     *
     * @return \DedexBundle\Entity\Ern381\CueType[]
     */

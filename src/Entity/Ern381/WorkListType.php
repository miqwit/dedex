...
class WorkListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\MusicalWorkType[] $musicalWork
     */
    private $musicalWork = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\MusicalWorkType $musicalWork
     */
    public function addToMusicalWork(\DedexBundle\Entity\Ern381\MusicalWorkType $musicalWork)
    {
     ...
     * A Composite containing details of a MusicalWork contained in a Resource.
     *
     * @return \DedexBundle\Entity\Ern381\MusicalWorkType[]
     */

...
class UserDefinedResourceType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\UserDefinedResourceTypeType $userDefinedResourceType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ResourceProprietaryIdType[] $userDefinedResourceId
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\MusicalWorkIdType[] $indirectUserDefinedResourceId
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\UserDefinedValueType[] $userDefinedValue
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\UserDefinedResourceDetailsByTerritoryType[] $userDefinedResourceDetailsByTerritory
     */
     ...
     * A Composite containing details of the Type of the UserDefinedResource.
     *
     * @return \DedexBundle\Entity\Ern381\UserDefinedResourceTypeType
     */
     ...
     * A Composite containing details of the Type of the UserDefinedResource.
     *
     * @param \DedexBundle\Entity\Ern381\UserDefinedResourceTypeType $userDefinedResourceType
     * @return self
     */
    public function setUserDefinedResourceType(?\DedexBundle\Entity\Ern381\UserDefinedResourceTypeType $userDefinedResourceType = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ResourceProprietaryIdType $userDefinedResourceId
     */
    public function addToUserDefinedResourceId(\DedexBundle\Entity\Ern381\ResourceProprietaryIdType $userDefinedResourceId)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\MusicalWorkIdType $indirectUserDefinedResourceId
     */
    public function addToIndirectUserDefinedResourceId(\DedexBundle\Entity\Ern381\MusicalWorkIdType $indirectUserDefinedResourceId)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\UserDefinedValueType $userDefinedValue
     */
    public function addToUserDefinedValue(\DedexBundle\Entity\Ern381\UserDefinedValueType $userDefinedValue)
    {
     ...
     * A Composite containing details of a UserDefinedValue.
     *
     * @return \DedexBundle\Entity\Ern381\UserDefinedValueType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\UserDefinedResourceDetailsByTerritoryType $userDefinedResourceDetailsByTerritory
     */
    public function addToUserDefinedResourceDetailsByTerritory(\DedexBundle\Entity\Ern381\UserDefinedResourceDetailsByTerritoryType $userDefinedResourceDetailsByTerritory)
    {
     ...
     * A Composite containing details of the UserDefinedResource which may vary according to Territory of release.
     *
     * @return \DedexBundle\Entity\Ern381\UserDefinedResourceDetailsByTerritoryType[]
     */

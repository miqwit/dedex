...
class HashSumType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\HashSumAlgorithmTypeType $hashSumAlgorithmType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @return \DedexBundle\Entity\Ern381\HashSumAlgorithmTypeType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @param \DedexBundle\Entity\Ern381\HashSumAlgorithmTypeType $hashSumAlgorithmType
     * @return self
     */
    public function setHashSumAlgorithmType(\DedexBundle\Entity\Ern381\HashSumAlgorithmTypeType $hashSumAlgorithmType)
    {

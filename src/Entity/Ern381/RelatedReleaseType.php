...
class RelatedReleaseType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ReleaseSummaryDetailsByTerritoryType[] $releaseSummaryDetailsByTerritory
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ReleaseRelationshipTypeType $releaseRelationshipType
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ReleaseSummaryDetailsByTerritoryType $releaseSummaryDetailsByTerritory
     */
    public function addToReleaseSummaryDetailsByTerritory(\DedexBundle\Entity\Ern381\ReleaseSummaryDetailsByTerritoryType $releaseSummaryDetailsByTerritory)
    {
     ...
     * A Composite containing summary details of Descriptors and other attributes of the Release which may vary according to Territory of Release. Territory of Release may be the world.
     *
     * @return \DedexBundle\Entity\Ern381\ReleaseSummaryDetailsByTerritoryType[]
     */
     ...
     * A Composite containing details of the Type of the relationship between the two Releases.
     *
     * @return \DedexBundle\Entity\Ern381\ReleaseRelationshipTypeType
     */
     ...
     * A Composite containing details of the Type of the relationship between the two Releases.
     *
     * @param \DedexBundle\Entity\Ern381\ReleaseRelationshipTypeType $releaseRelationshipType
     * @return self
     */
    public function setReleaseRelationshipType(\DedexBundle\Entity\Ern381\ReleaseRelationshipTypeType $releaseRelationshipType)
    {

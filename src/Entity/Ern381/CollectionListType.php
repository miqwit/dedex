...
class CollectionListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CollectionType[] $collection
     */
    private $collection = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\CollectionType $collection
     */
    public function addToCollection(\DedexBundle\Entity\Ern381\CollectionType $collection)
    {
     ...
     * A Composite containing details of a Collection contained in a Resource.
     *
     * @return \DedexBundle\Entity\Ern381\CollectionType[]
     */

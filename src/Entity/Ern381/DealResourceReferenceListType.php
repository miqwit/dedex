...
class DealResourceReferenceListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\PeriodType $period
     */
    private $period = null;
     ...
     * A Composite containing details about the Period of Time applicable to the Resources.
     *
     * @param \DedexBundle\Entity\Ern381\PeriodType $period
     * @return self
     */
    public function setPeriod(?\DedexBundle\Entity\Ern381\PeriodType $period = null)
    {
        $this->period = $period;
        return $this;
    }

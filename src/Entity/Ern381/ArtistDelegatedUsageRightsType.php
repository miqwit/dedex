...
class ArtistDelegatedUsageRightsType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\PeriodType $periodOfRightsDelegation
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CurrentTerritoryCodeType[] $territoryOfRightsDelegation
     */
     ...
     * A Composite containing details about a Period of Time for which the delegation of usage rights applies. Periods are typically described by at least a StartDate or EndDate.
     *
     * @param \DedexBundle\Entity\Ern381\PeriodType $periodOfRightsDelegation
     * @return self
     */
    public function setPeriodOfRightsDelegation(\DedexBundle\Entity\Ern381\PeriodType $periodOfRightsDelegation)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\CurrentTerritoryCodeType $territoryOfRightsDelegation
     */
    public function addToTerritoryOfRightsDelegation(\DedexBundle\Entity\Ern381\CurrentTerritoryCodeType $territoryOfRightsDelegation)
    {

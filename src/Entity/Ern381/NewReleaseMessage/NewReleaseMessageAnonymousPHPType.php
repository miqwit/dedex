...
namespace DedexBundle\Entity\Ern381\NewReleaseMessage;
...
class NewReleaseMessageAnonymousPHPType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CatalogTransferType $catalogTransfer
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\WorkListType $workList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CueSheetType[] $cueSheetList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ResourceListType $resourceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CollectionListType $collectionList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ReleaseListType $releaseList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\DealListType $dealList
     */
     ...
     * A Composite containing details of a Price change.
     *
     * @return \DedexBundle\Entity\Ern381\CatalogTransferType
     */
     ...
     * A Composite containing details of a Price change.
     *
     * @param \DedexBundle\Entity\Ern381\CatalogTransferType $catalogTransfer
     * @return self
     */
    public function setCatalogTransfer(?\DedexBundle\Entity\Ern381\CatalogTransferType $catalogTransfer = null)
    {
     ...
     * A Composite containing details of one or more MusicalWorks, a Performance of which is contained in the Resources of the NewReleaseMessage.
     *
     * @return \DedexBundle\Entity\Ern381\WorkListType
     */
     ...
     * A Composite containing details of one or more MusicalWorks, a Performance of which is contained in the Resources of the NewReleaseMessage.
     *
     * @param \DedexBundle\Entity\Ern381\WorkListType $workList
     * @return self
     */
    public function setWorkList(?\DedexBundle\Entity\Ern381\WorkListType $workList = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\CueSheetType $cueSheet
     */
    public function addToCueSheetList(\DedexBundle\Entity\Ern381\CueSheetType $cueSheet)
    {
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @return \DedexBundle\Entity\Ern381\CueSheetType[]
     */
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @param \DedexBundle\Entity\Ern381\CueSheetType[] $cueSheetList
     * @return self
     */
     ...
     * A Composite containing details of one or more Resources.
     *
     * @return \DedexBundle\Entity\Ern381\ResourceListType
     */
     ...
     * A Composite containing details of one or more Resources.
     *
     * @param \DedexBundle\Entity\Ern381\ResourceListType $resourceList
     * @return self
     */
    public function setResourceList(\DedexBundle\Entity\Ern381\ResourceListType $resourceList)
    {
     ...
     * A Composite containing details of one or more Collections contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @return \DedexBundle\Entity\Ern381\CollectionListType
     */
     ...
     * A Composite containing details of one or more Collections contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @param \DedexBundle\Entity\Ern381\CollectionListType $collectionList
     * @return self
     */
    public function setCollectionList(?\DedexBundle\Entity\Ern381\CollectionListType $collectionList = null)
    {
     ...
     * A Composite containing details of one or more DDEX Releases contained in the NewReleaseMessage.
     *
     * @return \DedexBundle\Entity\Ern381\ReleaseListType
     */
     ...
     * A Composite containing details of one or more DDEX Releases contained in the NewReleaseMessage.
     *
     * @param \DedexBundle\Entity\Ern381\ReleaseListType $releaseList
     * @return self
     */
    public function setReleaseList(\DedexBundle\Entity\Ern381\ReleaseListType $releaseList)
    {
     ...
     * A Composite containing details of one or more Deals governing the Usage of the Releases in the Message.
     *
     * @return \DedexBundle\Entity\Ern381\DealListType
     */
     ...
     * A Composite containing details of one or more Deals governing the Usage of the Releases in the Message.
     *
     * @param \DedexBundle\Entity\Ern381\DealListType $dealList
     * @return self
     */
    public function setDealList(?\DedexBundle\Entity\Ern381\DealListType $dealList = null)
    {

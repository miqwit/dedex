...
class ArtistType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ArtistRoleType[] $artistRole
     */
    private $artistRole = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ArtistRoleType $artistRole
     */
    public function addToArtistRole(\DedexBundle\Entity\Ern381\ArtistRoleType $artistRole)
    {

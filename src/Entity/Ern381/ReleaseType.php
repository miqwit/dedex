...
class ReleaseType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ReleaseIdType[] $releaseId
     */
    private $releaseId = [
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ExternalResourceLinkType[] $externalResourceLink
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\SalesReportingProxyReleaseIdType[] $salesReportingProxyReleaseId
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ReleaseResourceReferenceType[] $releaseResourceReferenceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ResourceOmissionReasonType $resourceOmissionReason
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ReleaseCollectionReferenceListType $releaseCollectionReferenceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ReleaseTypeType[] $releaseType
     */
    private $releaseType = [
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ReleaseDetailsByTerritoryType[] $releaseDetailsByTerritory
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\WebPageType[] $artistProfilePage
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\EventDateType $globalReleaseDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\EventDateType $globalOriginalReleaseDate
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ReleaseIdType $releaseId
     */
    public function addToReleaseId(\DedexBundle\Entity\Ern381\ReleaseIdType $releaseId)
    {
     ...
     * A Composite containing details of ReleaseIds. If available, a GRid has to be used. If the Release contains only one SoundRecording, the ISRC of the SoundRecording may be used instead. If the Release is an abstraction of a complete PhysicalProduct (such as a CD Album), the ICPN of the PhysicalProduct may be used instead.
     *
     * @return \DedexBundle\Entity\Ern381\ReleaseIdType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ExternalResourceLinkType $externalResourceLink
     */
    public function addToExternalResourceLink(\DedexBundle\Entity\Ern381\ExternalResourceLinkType $externalResourceLink)
    {
     ...
     * A Composite containing details of promotional or other material related to the Release.
     *
     * @return \DedexBundle\Entity\Ern381\ExternalResourceLinkType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\SalesReportingProxyReleaseIdType $salesReportingProxyReleaseId
     */
    public function addToSalesReportingProxyReleaseId(\DedexBundle\Entity\Ern381\SalesReportingProxyReleaseIdType $salesReportingProxyReleaseId)
    {
     ...
     * A Composite containing details of the A Composite containing details of the SalesReportingProxyReleaseId.
     *
     * @return \DedexBundle\Entity\Ern381\SalesReportingProxyReleaseIdType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ReleaseResourceReferenceType $releaseResourceReference
     */
    public function addToReleaseResourceReferenceList(\DedexBundle\Entity\Ern381\ReleaseResourceReferenceType $releaseResourceReference)
    {
     ...
     * A Composite containing details of one or more Resources contained in the Release.
     *
     * @return \DedexBundle\Entity\Ern381\ReleaseResourceReferenceType[]
     */
     ...
     * A Composite containing details of one or more Resources contained in the Release.
     *
     * @param \DedexBundle\Entity\Ern381\ReleaseResourceReferenceType[] $releaseResourceReferenceList
     * @return self
     */
     ...
     * A Composite containing details of a ResourceOmissionReason.
     *
     * @return \DedexBundle\Entity\Ern381\ResourceOmissionReasonType
     */
     ...
     * A Composite containing details of a ResourceOmissionReason.
     *
     * @param \DedexBundle\Entity\Ern381\ResourceOmissionReasonType $resourceOmissionReason
     * @return self
     */
    public function setResourceOmissionReason(?\DedexBundle\Entity\Ern381\ResourceOmissionReasonType $resourceOmissionReason = null)
    {
     ...
     * A Composite containing details of one or more Collections contained in the Release.
     *
     * @return \DedexBundle\Entity\Ern381\ReleaseCollectionReferenceListType
     */
     ...
     * A Composite containing details of one or more Collections contained in the Release.
     *
     * @param \DedexBundle\Entity\Ern381\ReleaseCollectionReferenceListType $releaseCollectionReferenceList
     * @return self
     */
    public function setReleaseCollectionReferenceList(?\DedexBundle\Entity\Ern381\ReleaseCollectionReferenceListType $releaseCollectionReferenceList = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ReleaseTypeType $releaseType
     */
    public function addToReleaseType(\DedexBundle\Entity\Ern381\ReleaseTypeType $releaseType)
    {
     ...
     * A Composite containing details of the form in which a ReleaseCreator anticipates offering the Release to Consumers. This may be overridden by the ReleaseType for specific Territories as specified in the ReleaseDetailsByTerritory Composite.
     *
     * @return \DedexBundle\Entity\Ern381\ReleaseTypeType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory
     */
    public function addToReleaseDetailsByTerritory(\DedexBundle\Entity\Ern381\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory)
    {
     ...
     * A Composite containing details of Descriptors and other attributes of the Release which may vary according to Territory of release.
     *
     * @return \DedexBundle\Entity\Ern381\ReleaseDetailsByTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\WebPageType $artistProfilePage
     */
    public function addToArtistProfilePage(\DedexBundle\Entity\Ern381\WebPageType $artistProfilePage)
    {
     ...
     * A Composite containing details of a WebPage for the Artist.
     *
     * @return \DedexBundle\Entity\Ern381\WebPageType[]
     */
     ...
     * A Composite containing details of the Date of the Event in which the Release was or will be first made globally available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD). This element is deprecated. DDEX advises that it may be removed at a future date and therefore recommends against using it.
     *
     * @param \DedexBundle\Entity\Ern381\EventDateType $globalReleaseDate
     * @return self
     */
    public function setGlobalReleaseDate(?\DedexBundle\Entity\Ern381\EventDateType $globalReleaseDate = null)
    {
     ...
     * A Composite containing details of the Date of the Event in which the collection of tracks for the Release (e.g. the equivalent physical album on vinyl) was or will be first made globally available for Usage, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD). This element is deprecated. DDEX advises that it may be removed at a future date and therefore recommends against using it.
     *
     * @param \DedexBundle\Entity\Ern381\EventDateType $globalOriginalReleaseDate
     * @return self
     */
    public function setGlobalOriginalReleaseDate(?\DedexBundle\Entity\Ern381\EventDateType $globalOriginalReleaseDate = null)
    {

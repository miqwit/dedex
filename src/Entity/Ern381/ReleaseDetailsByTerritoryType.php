...
class ReleaseDetailsByTerritoryType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\AdministratingRecordCompanyType[] $administratingRecordCompany
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\RelatedReleaseType[] $relatedRelease
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ResourceGroupType[] $resourceGroup
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\EventDateType $originalDigitalReleaseDate
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\AdministratingRecordCompanyType $administratingRecordCompany
     */
    public function addToAdministratingRecordCompany(\DedexBundle\Entity\Ern381\AdministratingRecordCompanyType $administratingRecordCompany)
    {
     ...
     * A Composite containing details of the AdministratingRecordCompany for the Release.
     *
     * @return \DedexBundle\Entity\Ern381\AdministratingRecordCompanyType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\RelatedReleaseType $relatedRelease
     */
    public function addToRelatedRelease(\DedexBundle\Entity\Ern381\RelatedReleaseType $relatedRelease)
    {
     ...
     * A Composite containing details of a Release (or a PhysicalProduct or a DigitalProduct derived from such a Release) which is related to this Release.
     *
     * @return \DedexBundle\Entity\Ern381\RelatedReleaseType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ResourceGroupType $resourceGroup
     */
    public function addToResourceGroup(\DedexBundle\Entity\Ern381\ResourceGroupType $resourceGroup)
    {
     ...
     * A Composite containing details of a group of some or all of the Resources in the Release. ResourceGroups are used to signal groupings or sequences of Resources within a Release. Examples include individual carriers in a multi-carrier Release or classical Work groupings as well as the default order of Resources within a Release.
     *
     * @return \DedexBundle\Entity\Ern381\ResourceGroupType[]
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available in electronic/online format for Usage (in ISO 8601:2004 format: YYYY-MM-DD). This element is deprecated. DDEX advises that it may be removed at a future date and therefore recommends against using it.
     *
     * @param \DedexBundle\Entity\Ern381\EventDateType $originalDigitalReleaseDate
     * @return self
     */
    public function setOriginalDigitalReleaseDate(?\DedexBundle\Entity\Ern381\EventDateType $originalDigitalReleaseDate = null)
    {

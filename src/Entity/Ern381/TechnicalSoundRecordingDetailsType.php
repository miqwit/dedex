...
class TechnicalSoundRecordingDetailsType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\BitRateType $bitRate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\SamplingRateType $samplingRate
     */
     ...
     * A Composite containing the BitRate for the audio data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DedexBundle\Entity\Ern381\BitRateType $bitRate
     * @return self
     */
    public function setBitRate(?\DedexBundle\Entity\Ern381\BitRateType $bitRate = null)
    {
     ...
     * A Composite containing the sampling rate of the SoundRecording and a UnitOfMeasure (the default is Hz).
     *
     * @param \DedexBundle\Entity\Ern381\SamplingRateType $samplingRate
     * @return self
     */
    public function setSamplingRate(?\DedexBundle\Entity\Ern381\SamplingRateType $samplingRate = null)
    {

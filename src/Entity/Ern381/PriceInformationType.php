...
class PriceInformationType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\PriceTypeType $priceType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\DescriptionType $description
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\PriceRangeTypeType $priceRangeType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\PriceType $wholesalePricePerUnit
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\PriceType $bulkOrderWholesalePricePerUnit
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\PriceType $suggestedRetailPrice
     */
     ...
     * A Composite containing further details of the Price, including a Price code that informs the DSP of the Price the Release should be offered at, often in combination with a rate card. This element should not be combined with WholesalePricePerUnit or BulkOrderWholesalePricePerUnit.
     *
     * @return \DedexBundle\Entity\Ern381\PriceTypeType
     */
     ...
     * A Composite containing further details of the Price, including a Price code that informs the DSP of the Price the Release should be offered at, often in combination with a rate card. This element should not be combined with WholesalePricePerUnit or BulkOrderWholesalePricePerUnit.
     *
     * @param \DedexBundle\Entity\Ern381\PriceTypeType $priceType
     * @return self
     */
    public function setPriceType(?\DedexBundle\Entity\Ern381\PriceTypeType $priceType = null)
    {
     ...
     * A Composite containing a Description of the differences between multiple PriceInformation Composites.
     *
     * @param \DedexBundle\Entity\Ern381\DescriptionType $description
     * @return self
     */
    public function setDescription(?\DedexBundle\Entity\Ern381\DescriptionType $description = null)
    {
     ...
     * A Composite containing a Type of Price according to its value range. Typical examples include 'budget' and 'front line'. This is an informative element which is not meant to be used to send instructions on the Price to be used by the DSP.
     *
     * @return \DedexBundle\Entity\Ern381\PriceRangeTypeType
     */
     ...
     * A Composite containing a Type of Price according to its value range. Typical examples include 'budget' and 'front line'. This is an informative element which is not meant to be used to send instructions on the Price to be used by the DSP.
     *
     * @param \DedexBundle\Entity\Ern381\PriceRangeTypeType $priceRangeType
     * @return self
     */
    public function setPriceRangeType(?\DedexBundle\Entity\Ern381\PriceRangeTypeType $priceRangeType = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit of Usage, which informs the informs the DSP of the Price the Release should be offered at. Note that this Price applies to all UseTypes referenced in a DealTerm Composite. This element should not be combined with PriceType.
     *
     * @return \DedexBundle\Entity\Ern381\PriceType
     */
     ...
     * A Composite containing details of a wholesale Price for a single unit of Usage, which informs the informs the DSP of the Price the Release should be offered at. Note that this Price applies to all UseTypes referenced in a DealTerm Composite. This element should not be combined with PriceType.
     *
     * @param \DedexBundle\Entity\Ern381\PriceType $wholesalePricePerUnit
     * @return self
     */
    public function setWholesalePricePerUnit(?\DedexBundle\Entity\Ern381\PriceType $wholesalePricePerUnit = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit, which informs the informs the DSP of the Price the Release should be offered at. Note that the size of a bulk order is defined in the contract between MessageSender and the MessageRecipient. This element should not be combined with PriceType.
     *
     * @param \DedexBundle\Entity\Ern381\PriceType $bulkOrderWholesalePricePerUnit
     * @return self
     */
    public function setBulkOrderWholesalePricePerUnit(?\DedexBundle\Entity\Ern381\PriceType $bulkOrderWholesalePricePerUnit = null)
    {
     ...
     * A Composite containing details of a suggested retail Price.
     *
     * @param \DedexBundle\Entity\Ern381\PriceType $suggestedRetailPrice
     * @return self
     */
    public function setSuggestedRetailPrice(?\DedexBundle\Entity\Ern381\PriceType $suggestedRetailPrice = null)
    {

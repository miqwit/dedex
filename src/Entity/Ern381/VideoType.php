...
class VideoType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\VideoTypeType $videoType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\VideoIdType[] $videoId
     */
    private $videoId = [
     ...
     *
     * @var \DedexBundle\Entity\Ern381\MusicalWorkIdType[] $indirectVideoId
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\VideoCueSheetReferenceType[] $videoCueSheetReference
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ReasonType $reasonForCueSheetAbsence
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\SoundRecordingCollectionReferenceListType $videoCollectionReferenceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\VideoDetailsByTerritoryType[] $videoDetailsByTerritory
     */
     ...
     * A Composite containing details of the Type of the Video.
     *
     * @return \DedexBundle\Entity\Ern381\VideoTypeType
     */
     ...
     * A Composite containing details of the Type of the Video.
     *
     * @param \DedexBundle\Entity\Ern381\VideoTypeType $videoType
     * @return self
     */
    public function setVideoType(?\DedexBundle\Entity\Ern381\VideoTypeType $videoType = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\VideoIdType $videoId
     */
    public function addToVideoId(\DedexBundle\Entity\Ern381\VideoIdType $videoId)
    {
     ...
     * A Composite containing details of an Identifier of the Video.
     *
     * @return \DedexBundle\Entity\Ern381\VideoIdType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\MusicalWorkIdType $indirectVideoId
     */
    public function addToIndirectVideoId(\DedexBundle\Entity\Ern381\MusicalWorkIdType $indirectVideoId)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\VideoCueSheetReferenceType $videoCueSheetReference
     */
    public function addToVideoCueSheetReference(\DedexBundle\Entity\Ern381\VideoCueSheetReferenceType $videoCueSheetReference)
    {
     ...
     * A Composite containing a VideoCueSheetReference for a CueSheet (specific to this Message).
     *
     * @return \DedexBundle\Entity\Ern381\VideoCueSheetReferenceType[]
     */
     ...
     * A Composite containing the textual Description of the reason for the Identifier being used as a proxy.
     *
     * @return \DedexBundle\Entity\Ern381\ReasonType
     */
     ...
     * A Composite containing the textual Description of the reason for the Identifier being used as a proxy.
     *
     * @param \DedexBundle\Entity\Ern381\ReasonType $reasonForCueSheetAbsence
     * @return self
     */
    public function setReasonForCueSheetAbsence(?\DedexBundle\Entity\Ern381\ReasonType $reasonForCueSheetAbsence = null)
    {
     ...
     * @return self
     */
    public function setReferenceTitle(?\DedexBundle\Entity\Ern381\ReferenceTitleType $referenceTitle = null)
    {
     ...
     * A Composite containing details of one or more Collections. The referenced Collection has to be of CollectionType VideoChapter.
     *
     * @param \DedexBundle\Entity\Ern381\SoundRecordingCollectionReferenceListType $videoCollectionReferenceList
     * @return self
     */
    public function setVideoCollectionReferenceList(?\DedexBundle\Entity\Ern381\SoundRecordingCollectionReferenceListType $videoCollectionReferenceList = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\VideoDetailsByTerritoryType $videoDetailsByTerritory
     */
    public function addToVideoDetailsByTerritory(\DedexBundle\Entity\Ern381\VideoDetailsByTerritoryType $videoDetailsByTerritory)
    {
     ...
     * A Composite containing details of Descriptors and other attributes of the Video which may vary according to Territory of release.
     *
     * @return \DedexBundle\Entity\Ern381\VideoDetailsByTerritoryType[]
     */

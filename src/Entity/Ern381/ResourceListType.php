...
class ResourceListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\SoundRecordingType[] $soundRecording
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *
     * @var \DedexBundle\Entity\Ern381\VideoType[] $video
     */
    private $video = [
     ...
     *
     * @var \DedexBundle\Entity\Ern381\ImageType[] $image
     */
    private $image = [
     ...
     *
     * @var \DedexBundle\Entity\Ern381\TextType[] $text
     */
    private $text = [
     ...
     *
     * @var \DedexBundle\Entity\Ern381\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *
     * @var \DedexBundle\Entity\Ern381\SoftwareType[] $software
     */
    private $software = [
     ...
     *
     * @var \DedexBundle\Entity\Ern381\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DedexBundle\Entity\Ern381\SoundRecordingType $soundRecording)
    {
     ...
     * A Composite containing details of a SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern381\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\MIDIType $mIDI
     */
    public function addToMIDI(\DedexBundle\Entity\Ern381\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     * A Composite containing details of a MIDI.
     *
     * @return \DedexBundle\Entity\Ern381\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\VideoType $video
     */
    public function addToVideo(\DedexBundle\Entity\Ern381\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     * A Composite containing details of a Video.
     *
     * @return \DedexBundle\Entity\Ern381\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\ImageType $image
     */
    public function addToImage(\DedexBundle\Entity\Ern381\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     * A Composite containing details of an Image.
     *
     * @return \DedexBundle\Entity\Ern381\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\TextType $text
     */
    public function addToText(\DedexBundle\Entity\Ern381\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     * A Composite containing details of a Text.
     *
     * @return \DedexBundle\Entity\Ern381\TextType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DedexBundle\Entity\Ern381\SheetMusicType $sheetMusic)
    {
     ...
     * A Composite containing details of a SheetMusic.
     *
     * @return \DedexBundle\Entity\Ern381\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\SoftwareType $software
     */
    public function addToSoftware(\DedexBundle\Entity\Ern381\SoftwareType $software)
    {
     ...
     * A Composite containing details of an item of Software.
     *
     * @return \DedexBundle\Entity\Ern381\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DedexBundle\Entity\Ern381\UserDefinedResourceType $userDefinedResource)
    {
     ...
     * A Composite containing details of a UserDefinedResource.
     *
     * @return \DedexBundle\Entity\Ern381\UserDefinedResourceType[]
     */

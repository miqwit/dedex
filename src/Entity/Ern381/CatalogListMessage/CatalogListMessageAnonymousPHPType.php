...
namespace DedexBundle\Entity\Ern381\CatalogListMessage;
...
class CatalogListMessageAnonymousPHPType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\CatalogItemType[] $catalogItem
     */
    private $catalogItem = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\CatalogItemType $catalogItem
     */
    public function addToCatalogItem(\DedexBundle\Entity\Ern381\CatalogItemType $catalogItem)
    {
     ...
     * A Composite containing details of a Release which is an item of the catalog.
     *
     * @return \DedexBundle\Entity\Ern381\CatalogItemType[]
     */

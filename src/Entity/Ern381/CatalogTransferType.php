...
class CatalogTransferType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\EventDateType $effectiveTransferDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\AllTerritoryCodeType[] $territoryCode
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\AllTerritoryCodeType[] $excludedTerritoryCode
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\PartyDescriptorType $transferringFrom
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\PartyDescriptorType $transferringTo
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the catalog is or was transferred. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern381\EventDateType $effectiveTransferDate
     * @return self
     */
    public function setEffectiveTransferDate(?\DedexBundle\Entity\Ern381\EventDateType $effectiveTransferDate = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\AllTerritoryCodeType $territoryCode
     */
    public function addToTerritoryCode(\DedexBundle\Entity\Ern381\AllTerritoryCodeType $territoryCode)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\AllTerritoryCodeType $excludedTerritoryCode
     */
    public function addToExcludedTerritoryCode(\DedexBundle\Entity\Ern381\AllTerritoryCodeType $excludedTerritoryCode)
    {
     ...
     * A Composite containing details of the old RightsController.
     *
     * @return \DedexBundle\Entity\Ern381\PartyDescriptorType
     */
     ...
     * A Composite containing details of the old RightsController.
     *
     * @param \DedexBundle\Entity\Ern381\PartyDescriptorType $transferringFrom
     * @return self
     */
    public function setTransferringFrom(\DedexBundle\Entity\Ern381\PartyDescriptorType $transferringFrom)
    {
     ...
     * A Composite containing details of the new RightsController.
     *
     * @param \DedexBundle\Entity\Ern381\PartyDescriptorType $transferringTo
     * @return self
     */
    public function setTransferringTo(\DedexBundle\Entity\Ern381\PartyDescriptorType $transferringTo)
    {

...
class AvRatingType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern381\RatingAgencyType $ratingAgency
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern381\DescriptionType[] $ratingSchemeDescription
     */
     ...
     * A Composite containing details of an Organization that issues the AvRating.
     *
     * @return \DedexBundle\Entity\Ern381\RatingAgencyType
     */
     ...
     * A Composite containing details of an Organization that issues the AvRating.
     *
     * @param \DedexBundle\Entity\Ern381\RatingAgencyType $ratingAgency
     * @return self
     */
    public function setRatingAgency(\DedexBundle\Entity\Ern381\RatingAgencyType $ratingAgency)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern381\DescriptionType $ratingSchemeDescription
     */
    public function addToRatingSchemeDescription(\DedexBundle\Entity\Ern381\DescriptionType $ratingSchemeDescription)
    {

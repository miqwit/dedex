...
class DealListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern371\ReleaseDealType[] $releaseDeal
     */
    private $releaseDeal = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\ReleaseDealType $releaseDeal
     */
    public function addToReleaseDeal(\DedexBundle\Entity\Ern371\ReleaseDealType $releaseDeal)
    {
     ...
     *  more Deals pertaining to one or more Releases.
     *
     * @return \DedexBundle\Entity\Ern371\ReleaseDealType[]
     */

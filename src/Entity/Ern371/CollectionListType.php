...
class CollectionListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern371\CollectionType[] $collection
     */
    private $collection = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\CollectionType $collection
     */
    public function addToCollection(\DedexBundle\Entity\Ern371\CollectionType $collection)
    {
     ...
     *  Collection contained in a Resource.
     *
     * @return \DedexBundle\Entity\Ern371\CollectionType[]
     */

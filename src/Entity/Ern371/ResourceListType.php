...
class ResourceListType
{
     ...
     *  SoundRecording.
     *
     * @var \DedexBundle\Entity\Ern371\SoundRecordingType[] $soundRecording
     */
     ...
     *  MIDI.
     *
     * @var \DedexBundle\Entity\Ern371\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *  Video.
     *
     * @var \DedexBundle\Entity\Ern371\VideoType[] $video
     */
    private $video = [
     ...
     *  Image.
     *
     * @var \DedexBundle\Entity\Ern371\ImageType[] $image
     */
    private $image = [
     ...
     *  Text.
     *
     * @var \DedexBundle\Entity\Ern371\TextType[] $text
     */
    private $text = [
     ...
     *  SheetMusic.
     *
     * @var \DedexBundle\Entity\Ern371\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *  of Software.
     *
     * @var \DedexBundle\Entity\Ern371\SoftwareType[] $software
     */
    private $software = [
     ...
     *  UserDefinedResource.
     *
     * @var \DedexBundle\Entity\Ern371\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DedexBundle\Entity\Ern371\SoundRecordingType $soundRecording)
    {
     ...
     *  SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern371\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\MIDIType $mIDI
     */
    public function addToMIDI(\DedexBundle\Entity\Ern371\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     *  MIDI.
     *
     * @return \DedexBundle\Entity\Ern371\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\VideoType $video
     */
    public function addToVideo(\DedexBundle\Entity\Ern371\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     *  Video.
     *
     * @return \DedexBundle\Entity\Ern371\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\ImageType $image
     */
    public function addToImage(\DedexBundle\Entity\Ern371\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     *  Image.
     *
     * @return \DedexBundle\Entity\Ern371\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\TextType $text
     */
    public function addToText(\DedexBundle\Entity\Ern371\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     *  Text.
     *
     * @return \DedexBundle\Entity\Ern371\TextType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DedexBundle\Entity\Ern371\SheetMusicType $sheetMusic)
    {
     ...
     *  SheetMusic.
     *
     * @return \DedexBundle\Entity\Ern371\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\SoftwareType $software
     */
    public function addToSoftware(\DedexBundle\Entity\Ern371\SoftwareType $software)
    {
     ...
     *  of Software.
     *
     * @return \DedexBundle\Entity\Ern371\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DedexBundle\Entity\Ern371\UserDefinedResourceType $userDefinedResource)
    {
     ...
     *  UserDefinedResource.
     *
     * @return \DedexBundle\Entity\Ern371\UserDefinedResourceType[]
     */

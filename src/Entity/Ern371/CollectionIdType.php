...
class CollectionIdType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern371\ICPNType $iCPN
     */
    private $iCPN = null;
     ...
     *  the syntax [0-9]{12,13} using XML Schema in the future.
     *
     * @return \DedexBundle\Entity\Ern371\ICPNType
     */
     ...
     *  the syntax [0-9]{12,13} using XML Schema in the future.
     *
     * @param \DedexBundle\Entity\Ern371\ICPNType $iCPN
     * @return self
     */
    public function setICPN(?\DedexBundle\Entity\Ern371\ICPNType $iCPN = null)
    {
        $this->iCPN = $iCPN;
        return $this;
    }

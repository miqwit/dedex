...
class ReleaseDetailsByTerritoryType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern371\ArtistType[] $displayArtist
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern371\AdministratingRecordCompanyType[] $administratingRecordCompany
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern371\RelatedReleaseType[] $relatedRelease
     */
     ...
     *  for the Release.
     *
     * @var \DedexBundle\Entity\Ern371\AvRatingType[] $avRating
     */
    private $avRating = [
     ...
     *
     * @var \DedexBundle\Entity\Ern371\CommentType $marketingComment
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern371\ResourceGroupType[] $resourceGroup
     */
     ...
     *  YYYY[-MM[-DD]]).
     *
     * @var \DedexBundle\Entity\Ern371\EventDateType $originalReleaseDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern371\EventDateType $originalDigitalReleaseDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern371\ArtistType[] $displayConductor
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\ArtistType $displayArtist
     */
    public function addToDisplayArtist(\DedexBundle\Entity\Ern371\ArtistType $displayArtist)
    {
     ...
     *  Identifier and Roles.
     *
     * @return \DedexBundle\Entity\Ern371\ArtistType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\AdministratingRecordCompanyType $administratingRecordCompany
     */
    public function addToAdministratingRecordCompany(\DedexBundle\Entity\Ern371\AdministratingRecordCompanyType $administratingRecordCompany)
    {
     ...
     *  AdministratingRecordCompany for the Release.
     *
     * @return \DedexBundle\Entity\Ern371\AdministratingRecordCompanyType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\RelatedReleaseType $relatedRelease
     */
    public function addToRelatedRelease(\DedexBundle\Entity\Ern371\RelatedReleaseType $relatedRelease)
    {
     ...
     *  which is related to this Release.
     *
     * @return \DedexBundle\Entity\Ern371\RelatedReleaseType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\AvRatingType $avRating
     */
    public function addToAvRating(\DedexBundle\Entity\Ern371\AvRatingType $avRating)
    {
     ...
     *  for the Release.
     *
     * @return \DedexBundle\Entity\Ern371\AvRatingType[]
     */
     ...
     *  promotion and marketing of the Release.
     *
     * @return \DedexBundle\Entity\Ern371\CommentType
     */
     ...
     *  promotion and marketing of the Release.
     *
     * @param \DedexBundle\Entity\Ern371\CommentType $marketingComment
     * @return self
     */
    public function setMarketingComment(?\DedexBundle\Entity\Ern371\CommentType $marketingComment = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\ResourceGroupType $resourceGroup
     */
    public function addToResourceGroup(\DedexBundle\Entity\Ern371\ResourceGroupType $resourceGroup)
    {
     ...
     *  default order of Resources within a Release.
     *
     * @return \DedexBundle\Entity\Ern371\ResourceGroupType[]
     */
     ...
     * @return self
     */
    public function setReleaseDate(?\DedexBundle\Entity\Ern371\EventDateType $releaseDate = null)
    {
     ...
     *  YYYY[-MM[-DD]]).
     *
     * @param \DedexBundle\Entity\Ern371\EventDateType $originalReleaseDate
     * @return self
     */
    public function setOriginalReleaseDate(?\DedexBundle\Entity\Ern371\EventDateType $originalReleaseDate = null)
    {
     ...
     *  therefore recommends against using it.
     *
     * @param \DedexBundle\Entity\Ern371\EventDateType $originalDigitalReleaseDate
     * @return self
     */
    public function setOriginalDigitalReleaseDate(?\DedexBundle\Entity\Ern371\EventDateType $originalDigitalReleaseDate = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern371\ArtistType $displayConductor
     */
    public function addToDisplayConductor(\DedexBundle\Entity\Ern371\ArtistType $displayConductor)
    {

...
class TechnicalSoundRecordingDetailsType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern371\BitRateType $bitRate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern371\SamplingRateType $samplingRate
     */
     ...
     *  audio data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DedexBundle\Entity\Ern371\BitRateType $bitRate
     * @return self
     */
    public function setBitRate(?\DedexBundle\Entity\Ern371\BitRateType $bitRate = null)
    {
     ...
     *  of the SoundRecording and a UnitOfMeasure (the default is Hz).
     *
     * @param \DedexBundle\Entity\Ern371\SamplingRateType $samplingRate
     * @return self
     */
    public function setSamplingRate(?\DedexBundle\Entity\Ern371\SamplingRateType $samplingRate = null)
    {

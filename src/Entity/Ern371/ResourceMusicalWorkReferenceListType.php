...
class ResourceMusicalWorkReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern371\ResourceMusicalWorkReferenceType[] $resourceMusicalWorkReference
     */
     ...
     */
    public function addToResourceMusicalWorkReference(\DedexBundle\Entity\Ern371\ResourceMusicalWorkReferenceType $resourceMusicalWorkReference)
    {
